...
return["<h1>View ad. Be upset. Keep us running.</h1>","<p>You may not like this ad, but it supports the developer and keeps this site free.</p>"].join("\n")}Object.defineProperty(n,"__esModule",{
value:!0});var r=e("../../lib/dom"),i=e("../../lib/runtime/global"),o=e("../../lib/runtime/timer");n.load=function(){return new Promise(function(e,t){o.systemTimer.setTimeout(function(){
var n=r.any(i.DOCUMENT,".Supporter iframe"),o=r.any(i.DOCUMENT,".Supporter-placeholder");o.length?n.length?(r.setStyle(o,"visibility","hidden"),r.empty(o),e(!0)):(r.setStyle(o,"visibility","visible"),
r.setHtml(o,a()),t(new Error("Ad blocker detected"))):e(!1)},1e3)})}},{"../../lib/dom":130,"../../lib/runtime/global":145,"../../lib/runtime/timer":156}],210:[function(e,t,n){"use strict"
;function a(e,t,n,s,u){if(null==l||l!=u){l=u,c.WINDOW.onerror=r;try{t&&-1!=t.indexOf(document.domain)&&o({userAgent:navigator.userAgent,message:e,uri:t,line:n,column:s,stack:i(u)})}finally{
c.WINDOW.onerror=a}}return!1}function r(){return!1}function i(e){if(e instanceof Error)return s.StackFrame.parse(e);try{throw new Error("stack frame")}catch(e){var t=s.StackFrame.parse(e)
;return t.length&&t.shift(),t.length&&t.shift(),t}}function o(e){var t=new XMLHttpRequest;t.open("POST","/log",!0),t.setRequestHeader("Content-Type","application/json"),t.send(JSON.stringify(e))}
Object.defineProperty(n,"__esModule",{value:!0});var s=e("../lib/debug"),c=e("../lib/runtime/global"),l=null;n.init=function(){c.WINDOW.onerror=a},n.log=function(e){l=e,o({
...
_.push(o.createElement("span",{key:"tab-spacer-last",className:"TabList-spacer"}));var S=r("TabList",f&&"TabList--disabled",d);return o.createElement("div",{className:S},o.createElement("div",{
...
onClick:function(e){g(e)},onKeyDown:E,onKeyUp:_,onMouseDown:S,onMouseEnter:K,onMouseLeave:N,onMouseUp:x},o.createElement("input",a.__assign({},I,{ref:function(t){e.input=t},disabled:l,name:m,
...
})),r.createElement("div",{className:"Practice-indicator GaugeRow u-hFlex",title:"The current key details"},r.createElement(s.Name,{className:"GaugeRow-name",name:"Current key"
...
var s=this,c=s.props,l=c.className,u=c.defaultValue,d=c.disabled,f=c.maxLength,m=c.name,p=c.placeholder,y=c.tabIndex,b=c.title,v=c.type,h=c.value,g=c.onBlur,k=c.onChange,E=c.onClick,_=c.onFocus,S=c.onKeyDown,K=c.onKeyUp,N=c.onMouseDown,x=c.onMouseEnter,w=c.onMouseLeave,O=c.onMouseUp,D=s.state.isFocused,C=r("TextField",d&&"is-disabled",D&&"is-focused",l),M={}
...
onBlur:t,onChange:i,onClick:E,onFocus:n,onKeyDown:S,onKeyUp:K,onMouseDown:N,onMouseEnter:x,onMouseLeave:w,onMouseUp:O})):o.createElement("input",a.__assign({},M,{ref:e,className:C,disabled:d,
maxLength:f,name:m,placeholder:p,tabIndex:y,title:b,type:v,onBlur:t,onChange:i,onClick:E,onFocus:n,onKeyDown:S,onKeyUp:K,onMouseDown:N,onMouseEnter:x,onMouseLeave:w,onMouseUp:O}))},t.propTypes={
...
function t(t){for(var n=e.call(this,t)||this,a=i.map(),r=u.getLayoutSet(),o=0,s=Object.values(r);o<s.length;o++){var c=s[o].language;null==a[c.id]&&(a[c.id]=c)}n.languageList=Object.values(a),
...
t.layout=d.byId(u.getLayoutSet(),n),e.setState(Object.assign({},e.state,{layout:t.layout}))},title:"Select layout"})),r.createElement("span",{className:"u-field"},r.createElement(o.CheckBox,{
...
className:null,title:null},t}(o.Component);n.Legend=l},{classnames:"classnames","prop-types":"prop-types",react:"react",tslib:"tslib"}],167:[function(e,t,n){"use strict"
...
}),function(){e.value!=S&&E(e.value)}):t.setState(Object.assign({},t.state,{isOpen:!1}),function(){e.value!=S&&E(e.value)}))}}var t=this,n=t.props,a=n.className,i=(n.defaultValue,
n.disabled),c=n.options,l=n.tabIndex,u=n.title,d=n.value,f=n.onBlur,m=n.onClick,p=n.onFocus,y=n.onKeyDown,b=n.onKeyUp,v=n.onMouseDown,h=n.onMouseEnter,g=n.onMouseLeave,k=n.onMouseUp,E=n.onSelect,_=t.state,S=_.currentValue,K=_.isFocused,N=_.isOpen,x=c.find(function(e){
return e.value==S})||null,w=r("OptionList",N&&"OptionList--open",i&&"is-disabled",K&&"is-focused",a),O=null!=x?x.name:"-";return o.createElement("span",{ref:function(e){t.button=e},className:w,
...
}(o.Component);n.OptionList=c},{classnames:"classnames","prop-types":"prop-types",react:"react",tslib:"tslib"}],160:[function(e,t,n){"use strict";Object.defineProperty(n,"__esModule",{value:!0})
...
title:y,onClick:function(e){g(e)},onKeyDown:E,onKeyUp:_,onMouseDown:S,onMouseEnter:K,onMouseLeave:N,onMouseUp:x},o.createElement("input",a.__assign({},M,{ref:function(t){e.input=t},disabled:l,name:m,
...
tslib:"tslib"}],31:[function(e,t,n){"use strict";function a(e){var t=e.onLayout,n=(e.onReset,e.onNext,e.onHelp),a=e.onConfigure;return u.createElement("div",null,!1,!1,u.createElement(p.IconButton,{
onClick:t,icon:u.createElement(_.default,null),title:"Switch layout"
}),u.createElement(h.ThemeButton,null),u.createElement(v.TextSizeButton,null),u.createElement(b.FullScreenButton,null),u.createElement(p.IconButton,{onClick:n,icon:u.createElement(k.default,null),
title:"Show guided tour with help slides"}),u.createElement(m.Button,{icon:u.createElement(E.default,null),label:"Settings...",
...
}),u.createElement(w.KeyTimeDeltas,{id:"Practice-keyTimeDeltas",className:"u-sizeFill u-hFlex",settings:t,statistics:a,lesson:n})),u.createElement("div",{
...
}),u.createElement(w.KeySet,{id:"Practice-keySet",className:"u-sizeFill u-hFlex",settings:t,statistics:a,lesson:n})),u.createElement("div",{className:"Practice-indicator GaugeRow u-hFlex",
title:"The current key details"},u.createElement(y.Name,{className:"GaugeRow-name",name:"Current key"}),u.createElement(w.CurrentKey,{id:"Practice-currentKey",className:"u-sizeFill u-hFlex",
settings:t,statistics:a,lesson:n})))}function i(e){var t=e.id,n=e.className,a=e.title,r=e.primaryName,i=e.primaryValue,o=e.secondaryName,s=e.secondaryValue,c=l("Gauge",n)
;return u.createElement("div",{id:t,className:c,title:a},u.createElement("div",{className:"Gauge-primary"},u.createElement("span",{className:"Gauge-name Gauge-name--primary"
},y.asName(r)),u.createElement("span",{className:"Gauge-value Gauge-value--primary"},y.asValue(i))),u.createElement("div",{className:"Gauge-secondary"},u.createElement("span",{
className:"Gauge-name Gauge-name--secondary"},y.asName(o)),u.createElement("span",{className:"Gauge-value Gauge-value--secondary"},y.asValueDelta(s))))}function o(){
g.startTour(u.createElement(s,null))}function s(){return u.createElement(g.Tour,{onStart:function(){},onShow:function(e){},onClose:function(){}},u.createElement(g.Slide,{
className:"Slide--large u-article"
},u.createElement("h1",null,"Learn Touch Typing"),u.createElement("p",null,"This is keybr.com, a web application that will help you teach touch typing. Touch typing is typing without using the sense of sight to find the keys. A person possessing touch typing skills will know their location on the keyboard through muscle memory. It can improve any individual's typing speed and accuracy dramatically."),u.createElement("p",null,"This is a short tutorial that will explain how this application works."),u.createElement("p",null,"You can use the left and right arrow keys to navigate through these slides.")),u.createElement(g.Slide,{
className:"Slide--large u-article"
},u.createElement("p",null,"This tutorial is based on these few principles:"),u.createElement("ul",null,u.createElement("li",null,"No boring, repetitive exercises. Unlike most other typing tutors, keybr does not force you to repeat the same lessons over and over again. This is very annoying and contributes very little to your learning."),u.createElement("li",null,"Keybr uses a sophisticated computer algorithm to generate typing lessons matching your skills. These lessons consist of random words generated from a subset of the current alphabet. The size of the subset and individual letter frequency is controlled by the algorithm to give you the best learning experience."))),u.createElement(g.Slide,{
className:"Slide--large u-article"
},u.createElement("p",null,"Initially it starts generating words from a small subset of the most frequent letters of the alphabet."),u.createElement("p",null,"When you are typing these words, keybr measures time to type a key for every letter in that subset. This time is used to measure your learning progress. The more familiar you become with a key, the shorter time does it takes you to type it."),u.createElement("p",null,"Once you familiarize yourself with the current subset of letters, the algorithm expands it, adding more and more letters to it.")),u.createElement(g.Slide,{
className:"Slide--large u-article"
},u.createElement("p",null,"As soon as the algorithm includes new letters to the current subset, frequency of these letters is artificially boosted, so that the newly added letters will appear in every generated word in a lesson."),u.createElement("p",null,"The algorithm can also artificially rearrange letter frequencies, putting emphasis on the letters with the worst time to type metric."),u.createElement("p",null,"So at any time, you will be typing the letters you are least familiar with.")),u.createElement(g.Slide,{
className:"Slide--small u-article",target:"#Practice-textInput",position:"n"
},u.createElement("p",null,"This is the text board. It displays the text to type out. The text is generated automatically.")),u.createElement(g.Slide,{className:"Slide--small u-article",
target:"#Practice-keyboard",position:"n"
},u.createElement("p",null,"This is the virtual keyboard. It helps you memorize key positions. Use it to find the keys, don't look at your keyboard!")),u.createElement(g.Slide,{
className:"Slide--small u-article",target:"#Practice-speed",position:"s"},u.createElement("p",null,"This is the typing speed indicator. Higher typing speed is better.")),u.createElement(g.Slide,{
className:"Slide--small u-article",target:"#Practice-errors",position:"s"
},u.createElement("p",null,"This is the error counter, it is increased every time you make a typo. Lower is better.")),u.createElement(g.Slide,{className:"Slide--small u-article",
target:"#Practice-score",position:"s"
},u.createElement("p",null,"This is the typing score in abstract points. Higher is better. The score is calculated from your typing speed, error count and the current alphabet size.")),u.createElement(g.Slide,{
className:"Slide--small u-article",target:"#Practice-keyTimeDeltas",position:"s"
},u.createElement("p",null,"This indicator shows how the time to type a key in the last lesson has changed compared to the average time for the same key.")),u.createElement(g.Slide,{
className:"Slide--small u-article",target:"#Practice-keySet",position:"s"
},u.createElement("p",null,"This indicator shows the current subset of letters used to generate lessons, and your confidence level for every letter in the subset:"),u.createElement("p",null,u.createElement(w.KeyLegend,{
isIncluded:!0,confidenceLevel:null})," ","A not calibrated key with unknown confidence level"),u.createElement("p",null,u.createElement(w.KeyLegend,{isIncluded:!0,confidenceLevel:0
})," ","A calibrated key with the least confidence level"),u.createElement("p",null,u.createElement(w.KeyLegend,{isIncluded:!0,confidenceLevel:1
})," ","A calibrated key with the most confidence level"),u.createElement("p",null,u.createElement(w.KeyLegend,{isIncluded:!0,confidenceLevel:1,isBoosted:!0
})," ","A key with boosted frequency"),u.createElement("p",null,u.createElement(w.KeyLegend,{isIncluded:!0,confidenceLevel:1,isForced:!0
})," ","A key that was manually included in lessons by the user"),u.createElement("p",null,u.createElement(w.KeyLegend,{isIncluded:!1,confidenceLevel:1
})," ","A key that was not yet included in lessons")),u.createElement(g.Slide,{className:"Slide--small u-article",target:"#Practice-currentKey",position:"s"
...
Object.defineProperty(n,"__esModule",{value:!0})
;var c=e("tslib"),l=e("classnames"),u=e("react"),d=e("../../../lib/math/round"),f=e("../../../lib/runtime/global"),m=e("../../../lib/ui/button"),p=e("../../../lib/ui/iconbutton"),y=e("../../../lib/ui/label"),b=e("../../../lib/ui/lnf/fullscreen-button"),v=e("../../../lib/ui/lnf/text-size-button"),h=e("../../../lib/ui/lnf/theme-button"),g=e("../../../lib/ui/tour"),k=e("../../../res/icon/custom/help"),E=e("../../../res/icon/custom/settings"),_=e("../../../res/icon/material-design/av/web"),S=(e("../../../res/icon/material-design/content/redo"),
e("../../../res/icon/material-design/content/undo"),
e("../../keyboard/input")),K=e("../events"),N=e("../practice"),x=e("./keyboard"),w=e("./lesson/key"),O=e("./loader/lesson"),D=e("./sound"),C=e("./textinput");n.newPracticePage=function(e,t,n,a){
return u.createElement(O.LessonLoader,{promise:function(){return n.load(e)},component:function(n){return u.createElement(M,{settings:e,database:t,lesson:n,practice:N.newPractice(e,t,n),onConfigure:a})
}})};var M=function(e){function t(t){var n=e.call(this,t)||this;return n.unlisten=null,n.state={fragment:null,result:null,achievements:null,focus:!1,layout:"normal"},n}return c.__extends(t,e),
t.prototype.componentDidMount=function(){function e(e){s.reset()}function t(e){s.reset()}function n(e){s.reset()}S.translate(null);var a=this,r=a.props,i=r.settings,s=r.practice
;f.WINDOW.addEventListener("focus",e),f.WINDOW.addEventListener("blur",t),f.DOCUMENT.addEventListener("visibilitychange",n);var c=K.listenLessonStarted(function(e){
a.setState(Object.assign({},a.state,{fragment:e}),function(){a.textInput.focus()})}),l=K.listenLessonAdvanced(function(e,t){switch(a.textInput.update(e),t.hit){case!0:D.playSound(D.S_CLICK);break
;case!1:D.playSound(D.S_BLIP)}}),u=K.listenLessonCompleted(function(e,t){a.setState(Object.assign({},a.state,{result:e,achievements:t})),
null!=t&&t.list.length>0?D.playSound(D.S_TADA):0==e.errors?D.playSound(D.S_CORRECT):D.playSound(D.S_WRONG)});a.unlisten=function(){f.WINDOW.removeEventListener("focus",e),
f.WINDOW.removeEventListener("blur",t),f.DOCUMENT.removeEventListener("visibilitychange",n),c(),l(),u(),a.unlisten=null},D.initSounds(i),s.next(),i.newSettings&&o()},
t.prototype.componentWillUnmount=function(){S.translate(null),this.unlisten(),g.closeTour()},t.prototype.render=function(){function e(e){return u.createElement("div",{id:"Practice-controls",
className:l("Practice-controls",e)},u.createElement(a,{onLayout:c,onReset:d,onNext:f,onHelp:m,onConfigure:_}))}function t(e){return u.createElement("div",{id:"Practice-indicators",
...
className:l("Practice-textInput",e)},u.createElement(C.TextInput,{ref:i,size:t,fragment:N,onFocus:p,onBlur:y}))}function i(e){v.textInput=e}function s(e){v.keyboard=e}function c(){var e;switch(O){
...
S.translate(b()),E.reset()})}function y(){v.setState(Object.assign({},v.state,{focus:!1}),function(){v.keyboard&&v.keyboard.blur(),S.translate(null)})}function b(){var e=E.listen()
;return S.newTranslator(g.layout,g.emulateLayout,{onKeyDown:function(t){e.onKeyDown(t),v.keyboard&&v.keyboard.keyDown(t)},onKeyUp:function(t){e.onKeyUp(t),v.keyboard&&v.keyboard.keyUp(t)},
onInput:function(t){e.onInput(t)}})}var v=this,h=v.props,g=h.settings,k=h.lesson,E=h.practice,_=h.onConfigure,K=v.state,N=K.fragment,w=K.focus,O=K.layout;if(!N)return u.createElement("section",{
...
},e("l--normal"),t("l--normal"),n("l--normal"),u.createElement("div",{id:"Practice-keyboard",className:l("Practice-keyboard","l--normal")},u.createElement(x.Keyboard,{ref:s,layout:g.layout,full:!0
},u.createElement(x.KeyLayer,null),w||u.createElement(x.MarkerLayer,null),w||u.createElement(x.IllustrationLayer,null))));case"compact":return u.createElement("section",{id:"Practice",
...
title:"Tiny Text Size"},{id:"theme--size-x2",title:"Small Text Size"},{id:"theme--size-x3",title:"Normal Text Size"},{id:"theme--size-x4",title:"Large Text Size"},{id:"theme--size-x5",
title:"Huge Text Size"}],d=function(e){function t(t){var n=e.call(this,t)||this;return n.state={currentIndex:u.length},n}return r.__extends(t,e),t.prototype.render=function(){
var e=this,t=e.props.onSwitch,n=e.state.currentIndex+1;n>=u.length&&(n=0);var r=u[n];return o.createElement(l.IconButton,{icon:o.createElement(s.default,null),title:'Switch to theme "'+r.title+'"',
onClick:function(i){a(r),e.setState(Object.assign({},e.state,{currentIndex:n}),function(){t()})}})},t.propTypes={onSwitch:i.func},t.defaultProps={onSwitch:function(){}},t}(o.Component)
;n.TextSizeButton=d},{"../../../res/icon/material-design/editor/format_size":195,"../../runtime/global":145,"../iconbutton":162,"prop-types":"prop-types",react:"react",tslib:"tslib"}],
195:[function(e,t,n){"use strict";Object.defineProperty(n,"__esModule",{value:!0});var a=e("tslib"),r=e("../../SvgIcon"),i=e("react");n.default=function(e){
return i.createElement(r.SvgIcon,a.__assign({},e),i.createElement("path",{d:"M18 8v6h10v24h6V14h10V8H18zM6 24h6v14h6V24h6v-6H6v6z"}))}},{"../../SvgIcon":175,react:"react",tslib:"tslib"}],
164:[function(e,t,n){"use strict";Object.defineProperty(n,"__esModule",{value:!0})
...
;return s?o.createElement("a",{ref:e,className:k,disabled:i,href:s,tabIndex:l,title:u,onBlur:d,onClick:f,onFocus:m,onKeyDown:p,onKeyUp:y,onMouseDown:b,onMouseEnter:v,onMouseLeave:h,onMouseUp:g
...
;return c?o.createElement("a",{ref:e,className:_,disabled:s,href:c,tabIndex:d,title:f,onBlur:m,onClick:p,onFocus:y,onKeyDown:b,onKeyUp:v,onMouseDown:h,onMouseEnter:g,onMouseLeave:k,onMouseUp:E
...
27:[function(e,t,n){"use strict";function a(e){
var t=e.className,n=e.settings,a=e.statistics,r=e.lessonKey,i=e.onClick,o=e.onMouseDown,d=e.onMouseEnter,f=e.onMouseLeave,m=e.onMouseUp,y=l("LessonKey","LessonKey--included",null==r.confidenceLevel&&"LessonKey--notCalibrated",r.isBoosted&&"LessonKey--boosted",r.isForced&&"LessonKey--forced",t),b=s(!0,r.confidenceLevel),v=c(n,a)
;return u.createElement("span",{key:r.letter.charCode,className:y,style:b,title:v(r),onClick:i,onMouseDown:o,onMouseEnter:d,onMouseLeave:f,onMouseUp:m},p.keyName(r.letter))}function r(e){
var t=e.className,n=e.settings,a=e.statistics,r=e.lessonKey,i=e.onClick,o=e.onMouseDown,d=e.onMouseEnter,f=e.onMouseLeave,m=e.onMouseUp,y=l("LessonKey","LessonKey--excluded",null==r.confidenceLevel&&"LessonKey--notCalibrated",t),b=s(!1,r.confidenceLevel),v=c(n,a)
;return u.createElement("span",{key:r.letter.charCode,className:y,style:b,title:v(r),onClick:i,onMouseDown:o,onMouseEnter:d,onMouseLeave:f,onMouseUp:m},p.keyName(r.letter))}function i(e){
var t=e.className,n=e.settings,a=e.statistics,r=e.lessonKey,i=l("KeyDetails",t),o=a.getKeyData(r.letter).learningRate(),s=p.formatSpeedEx(n);return null!=r.confidenceLevel?u.createElement("span",{
className:i},u.createElement(f.NameValue,{name:u.createElement(f.Name,{name:"Average typing speed"}),value:u.createElement(f.Value,{value:s(m.timeToSpeed(r.meanTime))}),title:"Average typing speed"
}),u.createElement(f.NameValue,{name:u.createElement(f.Name,{name:"Best typing speed"}),value:u.createElement(f.Value,{value:s(m.timeToSpeed(r.minTime))}),title:"Best typing speed"
}),u.createElement(f.NameValue,{name:u.createElement(f.Name,{name:"Confidence level"}),value:u.createElement(f.Value,{value:d.default(r.confidenceLevel,100)}),title:"Confidence level"
}),u.createElement(f.NameValue,{name:u.createElement(f.Name,{name:"Learning rate"}),value:u.createElement(f.Value,{value:p.formatLearningRate(n,o)}),title:"Learning rate"})):u.createElement("span",{
className:i},"Not calibrated, need more samples")}function o(e){e.settings;var t=e.keyData,n=t.letter,a=t.deltaTime;return u.createElement("span",{className:"KeyTimeDelta"
},u.createElement(f.NameValue,{name:u.createElement(f.Name,{name:p.keyName(n)}),value:u.createElement(f.ValueDelta,{value:d.default(a,1),invert:!0})}))}function s(e,t){return e?{
backgroundColor:p.confidenceColor(t)}:{}}function c(e,t){var n=p.formatSpeedEx(e);return function(a){var r=["Character '"+p.keyName(a.letter)+"'"];if(null!=a.confidenceLevel){
r.push("Average typing speed: "+n(m.timeToSpeed(a.meanTime))),r.push("Best typing speed: "+n(m.timeToSpeed(a.minTime))),r.push("Confidence level: "+d.default(a.confidenceLevel,100))
;var i=t.getKeyData(a.letter).learningRate();null!=i&&r.push("Learning rate: "+p.formatLearningRate(e,i))}else r.push("Not calibrated, need more samples")
;return a.isBoosted&&r.push("Boosted frequency"),a.isForced&&r.push("Added by user"),r.join(";\n")}}Object.defineProperty(n,"__esModule",{value:!0})
;var l=e("classnames"),u=e("react"),d=e("../../../../lib/math/round"),f=e("../../../../lib/ui/label"),m=e("../../result"),p=e("../util");n.IncludedKey=a,n.ExcludedKey=r,n.KeyLegend=function(e){
var t=e.className,n=e.confidenceLevel,a=e.isIncluded,r=e.isBoosted,i=e.isForced,o=e.onClick,c=e.onMouseDown,d=e.onMouseEnter,f=e.onMouseLeave,m=e.onMouseUp,p=l("LessonKey",1==a&&"LessonKey--included",1!=a&&"LessonKey--excluded",null==n&&"LessonKey--notCalibrated",1==r&&"LessonKey--boosted",1==i&&"LessonKey--forced",t),y=s(a,n)
;return u.createElement("span",{className:p,style:y,onClick:o,onMouseDown:c,onMouseEnter:d,onMouseLeave:f,onMouseUp:m},"?")},n.KeyDetails=i,n.KeyTimeDelta=o,n.KeyTimeDeltas=function(e){
for(var t=e.id,n=e.className,a=e.settings,r=e.statistics,i=(e.lesson,[]),s=0,c=r.keyData;s<c.length;s++){var d=c[s];d.deltaTime&&i.push(d)}return i.sort(function(e,t){return e.deltaTime-t.deltaTime}),
u.createElement("span",{id:t,className:l(n)},i.map(function(e){return u.createElement(o,{key:e.letter.charCode,settings:a,keyData:e})}))},n.KeySet=function(e){
var t=e.id,n=e.className,i=e.settings,o=e.statistics,s=e.lesson;return u.createElement("span",{id:t,className:l(n)},s.includeKeys.map(function(e){return u.createElement(a,{key:e.letter.charCode,
settings:i,statistics:o,lessonKey:e})}),s.excludeKeys.map(function(e){return u.createElement(r,{key:e.letter.charCode,settings:i,statistics:o,lessonKey:e})}))},n.CurrentKey=function(e){
var t=e.id,n=e.className,r=e.settings,o=e.statistics,s=e.lesson.boostedKey;return null!=s?u.createElement("span",{id:t,className:l(n)},u.createElement(a,{settings:r,statistics:o,lessonKey:s
})," ",u.createElement(i,{settings:r,statistics:o,lessonKey:s})):u.createElement("span",{id:t,className:l(n)},u.createElement("span",null,"No Key"))}},{"../../../../lib/math/round":142,
"../../../../lib/ui/label":163,"../../result":24,"../util":50,classnames:"classnames",react:"react"}],50:[function(e,t,n){"use strict";function a(e,t){return void 0===t&&(t=1),function(n,a){
return void 0===a&&(a=t),String(i.default(e.speedUnit.measure(n),a))+e.speedUnit.id}}Object.defineProperty(n,"__esModule",{value:!0});var r=e("../../../lib/color"),i=e("../../../lib/math/round")
;n.keyName=function(e){return String.fromCharCode(e.charCode).toUpperCase()},n.formatter=function(e,t){function n(n,a){return void 0===a&&(a=t),String(i.default(e.measure(n),a))+e.id}
return void 0===t&&(t=1),{speed:function(n,a){return void 0===a&&(a=t),String(i.default(e.measure(n),a))},learningRate:function(e){
return null!=e?"~"+n(e.perSample,1e3)+"/sample, ~"+n(e.perHour,1e3)+"/hour":"Uncertain"}}},n.formatSpeed=function(e,t){return void 0===t&&(t=1),function(n,a){return void 0===a&&(a=t),
String(i.default(e.speedUnit.measure(n),a))}},n.formatSpeedEx=a,n.formatLearningRate=function(e,t){if(null!=t){var n=a(e,1e3);return"~"+n(t.perSample)+"/sample, ~"+n(t.perHour)+"/hour"}
return"Uncertain"},n.COLOR_MIN_CONFIDENCE=r.Color.rgb(13369344),n.COLOR_MAX_CONFIDENCE=r.Color.rgb(973409),n.confidenceColor=function(e){
...
"use strict";function a(e){var t=e.layoutKey,n=e.elementMap,a=e.children,r=e.onClick,i=e.onMouseDown,o=e.onMouseEnter,s=e.onMouseLeave,c=e.onMouseUp,l=p(x,w,t.zone),u={"data-id":t.id}
;return b.createElement("svg",m.__assign({key:t.id,ref:function(e){n[t.id]=e},className:l,x:t.x,y:t.y,onClick:r,onMouseDown:i,onMouseEnter:o,onMouseLeave:s,onMouseUp:c},u),a)}function r(e){
var t=e.layoutKey,n=e.elementMap,a=e.children,r=e.onClick,i=e.onMouseDown,o=e.onMouseEnter,s=e.onMouseLeave,c=e.onMouseUp,l=p(x,O,t.zone),u={"data-id":t.id};return b.createElement("svg",m.__assign({
key:t.id,ref:function(e){n[t.id]=e},className:l,x:t.x,y:t.y,onClick:r,onMouseDown:i,onMouseEnter:o,onMouseLeave:s,onMouseUp:c},u),a)}function i(e){
var t=e.className,n=e.x,a=e.y,r=e.text,i=e.textAnchor,o=p(M,t);return b.createElement("text",{className:o,x:n,y:a,textAnchor:i},r)}function o(e){
var t=e.className,n=e.x,a=e.y,r=e.text,i=e.charCode,o=e.textAnchor;i>0&&(g.isCombiningDiacritic(i)&&(i=g.getDiacritic(i).diacritic,t=[A,t]),r=String.fromCharCode(i).toUpperCase());var s=p(M,I,t)
;return b.createElement("text",{className:s,x:n,y:a,textAnchor:o},r)}function s(e){var t=e.className,n=e.x,a=e.y,r=e.text,i=e.charCode,o=e.textAnchor
;i>0&&(g.isCombiningDiacritic(i)&&(i=g.getDiacritic(i).diacritic,t=[A,t]),r=String.fromCharCode(i));var s=p(M,T,t);return b.createElement("text",{className:s,x:n,y:a,textAnchor:o},r)}function c(e,t){
return{id:e,vk:null,a:null,b:null,c:null,d:null,x:t.x,y:t.y,shape:t.shape,zone:t.zone}}function l(e){return String.fromCharCode(e).toUpperCase()}function u(e){var t=e.layoutKey,n=L[t.shape]
;if(n)return n(Object.assign({},e,{key:t.id}));throw new Error}function d(e,t,n){var a=e[t];a&&(n?v.addClass(a,D):v.removeClass(a,D))}function f(e,t){t.ctrlKey||(d(e,"ControlLeft",!1),
d(e,"ControlRight",!1)),t.altKey||(d(e,"AltLeft",!1),d(e,"AltRight",!1)),t.shiftKey||(d(e,"ShiftLeft",!1),d(e,"ShiftRight",!1))}Object.defineProperty(n,"__esModule",{value:!0})
;var m=e("tslib"),p=e("classnames"),y=e("prop-types"),b=e("react"),v=e("../../../lib/dom"),h=e("../../../lib/lang"),g=e("../../../lib/unicode"),k=e("../../../data/geometry"),E=function(e){
function t(t){var n=e.call(this,t)||this;return n.elementMap=h.map(),n.state={focus:!1},n}return m.__extends(t,e),t.prototype.getChildContext=function(){return{layout:this.props.layout,
...
this.setState(Object.assign({},this.state,{focus:!1}))},t.prototype.keyDown=function(e){d(this.elementMap,e.code,!0),f(this.elementMap,e)},t.prototype.keyUp=function(e){d(this.elementMap,e.code,!1),
f(this.elementMap,e)},t.prototype.render=function(){var e=this.props,t=e.children,n=(e.layout,e.full),a=n?1e3:671;return b.createElement("div",{className:p("KeyboardWrap",n&&"KeyboardWrap--full")
},b.createElement("svg",{className:p("Keyboard",n&&"Keyboard--full"),viewBox:"0 0 "+a+" 250"},b.createElement("rect",{className:"Keyboard-frame",x:0,y:0,width:a,height:250,rx:10,ry:10}),t))},
t.propTypes={children:y.any,layout:y.object.isRequired,full:y.bool.isRequired},t.defaultProps={children:null,layout:null,full:!1},t.childContextTypes={layout:y.object.isRequired,
full:y.bool.isRequired,elementMap:y.object.isRequired},t}(b.Component);n.Keyboard=E;var _=function(e){function t(){return null!==e&&e.apply(this,arguments)||this}return m.__extends(t,e),t
}(b.Component);n.Layer=_;var S=function(e){function t(){return null!==e&&e.apply(this,arguments)||this}return m.__extends(t,e),t.prototype.render=function(){
for(var e=this.context,t=e.layout,n=e.full,a=e.elementMap,r=[],i=0,o=Object.entries(t.geometryMap);i<o.length;i++){var s=o[i],l=s[0],d=s[1];r.push(t.keysById[l]||c(l,d))}if(r.sort(function(e,t){
return e.y-t.y||e.x-t.x}),n){for(var f=0,m=Object.entries(k.CONTROL_PAD);f<m.length;f++){var p=m[f],l=p[0],d=p[1];r.push(c(l,d))}for(var y=0,v=Object.entries(k.CURSOR_PAD);y<v.length;y++){
var h=v[y],l=h[0],d=h[1];r.push(c(l,d))}for(var g=0,E=Object.entries(k.NUM_PAD);g<E.length;g++){var _=E[g],l=_[0],d=_[1];r.push(c(l,d))}}return b.createElement("svg",{className:"Keyboard-layout",x:21,
y:21},r.map(function(e){return u({layoutKey:e,elementMap:a})}))},t.contextTypes={layout:y.object.isRequired,full:y.bool.isRequired,elementMap:y.object.isRequired},t}(_);n.KeyLayer=S;var K=function(e){
function t(){return null!==e&&e.apply(this,arguments)||this}return m.__extends(t,e),t.prototype.render=function(){var e=this.context;return e.layout,e.full,e.elementMap,b.createElement("svg",{
className:"Keyboard-marker",x:21,y:21})},t.contextTypes={layout:y.object.isRequired,full:y.bool.isRequired,elementMap:y.object.isRequired},t}(_);n.MarkerLayer=K;var N=function(e){function t(){
return null!==e&&e.apply(this,arguments)||this}return m.__extends(t,e),t.prototype.render=function(){return b.createElement("svg",{className:"Keyboard-illustration",x:0,y:0},b.createElement("svg",{
x:41,y:41},b.createElement("circle",{cx:72,cy:84,r:20,className:"m"}),b.createElement("circle",{cx:114,cy:84,r:20,className:"m"}),b.createElement("circle",{cx:156,cy:84,r:20,className:"m"
}),b.createElement("circle",{cx:198,cy:84,r:20,className:"m x"}),b.createElement("circle",{cx:324,cy:84,r:20,className:"m x"}),b.createElement("circle",{cx:366,cy:84,r:20,className:"m"
}),b.createElement("circle",{cx:408,cy:84,r:20,className:"m"}),b.createElement("circle",{cx:450,cy:84,r:20,className:"m"})),b.createElement("image",{x:10,y:10,width:656,height:271,
xlinkHref:"/res/image/hands_above.svg"}))},t}(_);n.IllustrationLayer=N
;var x="KeyboardKey",w=x+"--simple",O=x+"--special",D=x+"--depressed",C=x+"-button",M=x+"-symbol",I=M+"--primary",T=M+"--secondary",A=M+"--dead";n.Key=a,n.SpecialKey=r;var L={key:function(e){
var t=e.layoutKey,n=t.a>0&&t.b>0&&l(t.a)==l(t.b);return b.createElement(a,m.__assign({},e),b.createElement("rect",{className:C,x:0,y:0,width:40,height:40}),t.b>0&&!n&&b.createElement(s,{x:10,y:15,
charCode:t.b}),t.a>0&&!n&&b.createElement(s,{x:10,y:30,charCode:t.a}),t.d>0&&b.createElement(s,{x:28,y:15,charCode:t.d}),t.c>0&&b.createElement(s,{x:28,y:30,charCode:t.c}),n&&b.createElement(o,{x:15,
y:25,charCode:t.a}))},"key-backslash":function(e){var t=e.layoutKey,n=t.a>0&&t.b>0&&l(t.a)==l(t.b);return b.createElement(a,m.__assign({},e),b.createElement("rect",{className:C,x:0,y:0,width:60,
height:40}),t.b>0&&!n&&b.createElement(s,{x:10,y:15,charCode:t.b}),t.a>0&&!n&&b.createElement(s,{x:10,y:30,charCode:t.a}),t.d>0&&b.createElement(s,{x:28,y:15,charCode:t.d}),t.c>0&&b.createElement(s,{
x:28,y:30,charCode:t.c}),n&&b.createElement(o,{x:15,y:25,charCode:t.a}))},"key-left-shift":function(e){return b.createElement(r,m.__assign({},e),b.createElement("rect",{className:C,x:0,y:0,width:92,
height:40}),b.createElement(i,{x:15,y:25,text:"Shift"}))},"key-left-shift-standard-102":function(e){return b.createElement(r,m.__assign({},e),b.createElement("rect",{className:C,x:0,y:0,width:50,
height:40}),b.createElement(i,{x:15,y:25,text:"Shift"}))},"key-right-shift":function(e){return b.createElement(r,m.__assign({},e),b.createElement("rect",{className:C,x:0,y:0,width:115,height:40
}),b.createElement(i,{x:15,y:25,text:"Shift"}))},"key-ctrl":function(e){return b.createElement(r,m.__assign({},e),b.createElement("rect",{className:C,x:0,y:0,width:63,height:40}),b.createElement(i,{
x:15,y:25,text:"Ctrl"}))},"key-alt":function(e){return b.createElement(r,m.__assign({},e),b.createElement("rect",{className:C,x:0,y:0,width:63,height:40}),b.createElement(i,{x:15,y:25,text:"Alt"}))},
"key-alt-gr":function(e){return b.createElement(r,m.__assign({},e),b.createElement("rect",{className:C,x:0,y:0,width:63,height:40}),b.createElement(i,{x:15,y:25,text:"Alt Gr"}))},
"key-tab":function(e){return b.createElement(r,m.__assign({},e),b.createElement("rect",{className:C,x:0,y:0,width:63,height:40}),b.createElement(i,{x:15,y:25,text:"Tab"}))},
"key-caps-lock":function(e){return b.createElement(r,m.__assign({},e),b.createElement("rect",{className:C,x:0,y:0,width:70,height:40}),b.createElement(i,{x:15,y:25,text:"Caps Lock"}))},
"key-backspace":function(e){return b.createElement(r,m.__assign({},e),b.createElement("rect",{className:C,x:0,y:0,width:83,height:40}),b.createElement(i,{x:15,y:25,text:"Backspace"}))},
"key-enter":function(e){return b.createElement(r,m.__assign({},e),b.createElement("rect",{className:C,x:0,y:0,width:95,height:40}),b.createElement(i,{x:15,y:25,text:"Enter"}))},
"key-enter-standard-102":function(e){return b.createElement(r,m.__assign({},e),b.createElement("path",{className:C,d:"m 0,0 0,40 7,0 0,42 53,0 0,-82 z"}),b.createElement(i,{x:15,y:25,text:"Enter"}))},
"key-space":function(e){return b.createElement(a,m.__assign({},e),b.createElement("rect",{className:C,x:0,y:0,width:369,height:40}))},"key-home":function(e){
return b.createElement(a,m.__assign({},e),b.createElement("rect",{className:C,x:0,y:0,width:40,height:40}),b.createElement(i,{x:5,y:16,text:"Home"}))},"key-end":function(e){
return b.createElement(a,m.__assign({},e),b.createElement("rect",{className:C,x:0,y:0,width:40,height:40}),b.createElement(i,{x:5,y:16,text:"End"}))},"key-insert":function(e){
return b.createElement(a,m.__assign({},e),b.createElement("rect",{className:C,x:0,y:0,width:40,height:40}),b.createElement(i,{x:5,y:16,text:"Insert"}))},"key-delete":function(e){
return b.createElement(a,m.__assign({},e),b.createElement("rect",{className:C,x:0,y:0,width:40,height:40}),b.createElement(i,{x:5,y:16,text:"Delete"}))},"key-page-up":function(e){
return b.createElement(a,m.__assign({},e),b.createElement("rect",{className:C,x:0,y:0,width:40,height:40}),b.createElement(i,{x:5,y:16,text:"Page"}),b.createElement(i,{x:5,y:28,text:"Up"}))},
"key-page-down":function(e){return b.createElement(a,m.__assign({},e),b.createElement("rect",{className:C,x:0,y:0,width:40,height:40}),b.createElement(i,{x:5,y:16,text:"Page"}),b.createElement(i,{x:5,
y:28,text:"Down"}))},"key-up":function(e){return b.createElement(a,m.__assign({},e),b.createElement("rect",{className:C,x:0,y:0,width:40,height:40}),b.createElement(o,{x:20,y:25,text:"↑",
textAnchor:"middle"}))},"key-down":function(e){return b.createElement(a,m.__assign({},e),b.createElement("rect",{className:C,x:0,y:0,width:40,height:40}),b.createElement(o,{x:20,y:25,text:"↓",
textAnchor:"middle"}))},"key-left":function(e){return b.createElement(a,m.__assign({},e),b.createElement("rect",{className:C,x:0,y:0,width:40,height:40}),b.createElement(o,{x:20,y:25,text:"←",
textAnchor:"middle"}))},"key-right":function(e){return b.createElement(a,m.__assign({},e),b.createElement("rect",{className:C,x:0,y:0,width:40,height:40}),b.createElement(o,{x:20,y:25,text:"→",
textAnchor:"middle"}))},"key-np-num-lock":function(e){return b.createElement(a,m.__assign({},e),b.createElement("rect",{className:C,x:0,y:0,width:40,height:40}),b.createElement(i,{x:5,y:16,text:"Num"
}),b.createElement(i,{x:5,y:28,text:"Lock"}))},"key-np-divide":function(e){return b.createElement(a,m.__assign({},e),b.createElement("rect",{className:C,x:0,y:0,width:40,height:40
}),b.createElement(o,{x:15,y:25,text:"⁄"}))},"key-np-multiply":function(e){return b.createElement(a,m.__assign({},e),b.createElement("rect",{className:C,x:0,y:0,width:40,height:40
}),b.createElement(o,{x:15,y:25,text:"×"}))},"key-np-subtract":function(e){return b.createElement(a,m.__assign({},e),b.createElement("rect",{className:C,x:0,y:0,width:40,height:40
}),b.createElement(o,{x:15,y:25,text:"−"}))},"key-np-add":function(e){return b.createElement(a,m.__assign({},e),b.createElement("rect",{className:C,x:0,y:0,width:40,height:82}),b.createElement(o,{
x:15,y:25,text:"+"}))},"key-np-enter":function(e){return b.createElement(a,m.__assign({},e),b.createElement("rect",{className:C,x:0,y:0,width:40,height:82}),b.createElement(i,{x:5,y:16,text:"Enter"}))
},"key-np-decimal":function(e){return b.createElement(a,m.__assign({},e),b.createElement("rect",{className:C,x:0,y:0,width:40,height:40}),b.createElement(o,{x:8,y:18,text:"."}),b.createElement(i,{
x:35,y:32,text:"Del",textAnchor:"end"}))},"key-np-0":function(e){return b.createElement(a,m.__assign({},e),b.createElement("rect",{className:C,x:0,y:0,width:82,height:40}),b.createElement(o,{x:8,y:18,
text:"0"}),b.createElement(i,{x:77,y:32,text:"Ins",textAnchor:"end"}))},"key-np-1":function(e){return b.createElement(a,m.__assign({},e),b.createElement("rect",{className:C,x:0,y:0,width:40,height:40
}),b.createElement(o,{x:8,y:18,text:"1"}),b.createElement(i,{x:35,y:32,text:"End",textAnchor:"end"}))},"key-np-2":function(e){return b.createElement(a,m.__assign({},e),b.createElement("rect",{
className:C,x:0,y:0,width:40,height:40}),b.createElement(o,{x:8,y:18,text:"2"}),b.createElement(i,{x:35,y:32,text:"↓",textAnchor:"end"}))},"key-np-3":function(e){
return b.createElement(a,m.__assign({},e),b.createElement("rect",{className:C,x:0,y:0,width:40,height:40}),b.createElement(o,{x:8,y:18,text:"3"}),b.createElement(i,{x:35,y:32,text:"Pg Dn",
textAnchor:"end"}))},"key-np-4":function(e){return b.createElement(a,m.__assign({},e),b.createElement("rect",{className:C,x:0,y:0,width:40,height:40}),b.createElement(o,{x:8,y:18,text:"4"
}),b.createElement(i,{x:35,y:32,text:"←",textAnchor:"end"}))},"key-np-5":function(e){return b.createElement(a,m.__assign({},e),b.createElement("rect",{className:C,x:0,y:0,width:40,height:40
}),b.createElement(o,{x:8,y:18,text:"5"}))},"key-np-6":function(e){return b.createElement(a,m.__assign({},e),b.createElement("rect",{className:C,x:0,y:0,width:40,height:40}),b.createElement(o,{x:8,
y:18,text:"6"}),b.createElement(i,{x:35,y:32,text:"→",textAnchor:"end"}))},"key-np-7":function(e){return b.createElement(a,m.__assign({},e),b.createElement("rect",{className:C,x:0,y:0,width:40,
height:40}),b.createElement(o,{x:8,y:18,text:"7"}),b.createElement(i,{x:35,y:32,text:"Home",textAnchor:"end"}))},"key-np-8":function(e){
return b.createElement(a,m.__assign({},e),b.createElement("rect",{className:C,x:0,y:0,width:40,height:40}),b.createElement(o,{x:8,y:18,text:"8"}),b.createElement(i,{x:35,y:32,text:"↑",textAnchor:"end"
}))},"key-np-9":function(e){return b.createElement(a,m.__assign({},e),b.createElement("rect",{className:C,x:0,y:0,width:40,height:40}),b.createElement(o,{x:8,y:18,text:"9"}),b.createElement(i,{x:35,
...
if(!j(e))throw new TypeError;var n=z(e.className.baseVal),a=void 0;-1!=(a=n.indexOf(t))?n.splice(a,1):n.push(t),e.className.baseVal=n.join(" ")}}function S(e,t,n){
if(Array.isArray(e))for(var a=0,r=e;a<r.length;a++)K(r[a],t,n);else K(e,t,n)}function K(e,t,n){var a=e.style;a[w(a,t)]=String(n)}function N(e,t){
if(Array.isArray(e))for(var n=0,a=e;n<a.length;n++)x(a[n],t);else x(e,t)}function x(e,t){for(var n=0,a=Object.entries(t);n<a.length;n++){var r=a[n];S(e,r[0],r[1])}}function w(e,t){
...
if(Array.isArray(e))for(var n=0,a=e;n<a.length;n++)E(a[n],t);else E(e,t)},n.toggleClass0=E,n.setStyle=S,n.setStyleMap=N,n.getStyle=function(e,t){var n=getComputedStyle(e,null);return n[w(n,t)]}
...
l(h)},nextWord:function(e,t,n){return u(h,a(e),r(t),n)}}}},{"../../../lib/lang":139,"../../../lib/math/random":141}],19:[function(e,t,n){"use strict";Object.defineProperty(n,"__esModule",{value:!0})
;var a=e("../../../lib/math/random"),r=e("../../keyboard/layout"),i=e("../letter"),o=e("../result"),s=e("./wordfilter");n.newGuidedLesson=function(e,t){var n=r.layoutCharCodes(e.layout,{
enableDeadKeys:!1}),c=i.sortLetters(i.filterLetters(t.letters,n),i.orderByFrequency),l=i.filterLetters(i.punctuators,n),u=[],d=[],f=null;return{get letters(){return c},get includeKeys(){return u},
get excludeKeys(){return d},get boostedKey(){return f},generate:function(){function n(e){try{for(var n=0,a="";n<3;)if(a=t.nextWord(i,o,c),s.allow(a)){if(a!=e)return a;n++}return a}catch(e){
return null!=o?String.fromCharCode(o.charCode):"?"}}function r(e){return e?e.letter:null}var i=function(e){return e&&e.length?e.map(r):null
}(u),o=r(f),c=5+Math.round(4*e.lesson.length),d=50+Math.round(100*e.lesson.length);t.reset();for(var m="",p="";m.length<d;){var y=p=n(p)
;if(e.lesson.capitals&&(y=y.substring(0,1).toUpperCase()+y.substring(1)),e.lesson.punctuators){var b=String.fromCharCode(a.pickWeighted(l,function(e){return e.f}).charCode);switch(b){case null:break
;case"-":y=y+"-"+n(p);break;case"(":y="("+y+")";break;case"[":y="["+y+"]";break;case'"':y='"'+y+'"';break;case"'":y=y+"'"+n(p);break;default:y+=b}}0==m.length?m=y:m+=" "+y}return m},
update:function(t){var n=o.MIN_SIZE,a=n+Math.round((c.length-n)*e.lesson.complexity);u=[],d=[],f=null;for(var r=[],i=0,s=null,l=0;l<c.length;l++){var m=c[l],p=t.getKeyData(m);s={letter:m,
meanTime:p.movingMean.mean,minTime:p.movingMean.min,confidenceLevel:p.confidenceLevel,isConfident:p.isConfident,isBoosted:!1,isForced:l>=n&&l<a},l<n?(u.push(s),
s.isConfident||i++):s.isConfident?u.push(s):r.push(s)}for(r.length>0&&i<1&&(s=r.shift(),u.push(s));r.length>0;)(s=r.shift()).isForced?u.push(s):d.push(s);var y=u.filter(function(e){
return null==e.confidenceLevel||e.confidenceLevel<1});y.length>0&&(y.sort(function(e,t){var n=e.confidenceLevel||0,a=t.confidenceLevel||0;return n==a?t.letter.f-e.letter.f:n-a}),
(f=y.shift()).isBoosted=!0)}}}},{"../../../lib/math/random":141,"../../keyboard/layout":5,"../letter":22,"../result":24,"./wordfilter":21}],21:[function(e,t,n){"use strict"
;Object.defineProperty(n,"__esModule",{value:!0});var a=e("../../../lib/lang").map({97:110,98:111,99:112,100:113,101:114,102:115,103:116,104:117,105:118,106:119,107:120,108:121,109:122,110:97,111:98,
112:99,113:100,114:101,115:102,116:103,117:104,118:105,119:106,120:107,121:108,122:109
...
var c=r.layoutCharCodes(e.layout,{}),l=o.sortLetters(o.filterLetters(t.letters,c),o.orderByIndex),u=(o.filterLetters(o.punctuators,c),[]),d=[],f=null
...
get letters(){return l},get includeKeys(){return u},get excludeKeys(){return d},get boostedKey(){return f},generate:function(){for(var e="",t=0,n=" ";y!=i.SPLIT&&t<5;){
if(""==e)"\n"!=y&&(e=y);else if("\n"==y)n="\n",t++;else{if(e.length+y.length+1>80)break;e=e+n+y,n=" "}s()}for(;y==i.SPLIT;)s();return e},update:function(e){u=[],d=[],f=null
;for(var t=null,n=0;n<l.length;n++){var a=l[n],r=e.getKeyData(a);t={letter:a,meanTime:r.movingMean.mean,minTime:r.movingMean.min,confidenceLevel:r.confidenceLevel,isConfident:r.isConfident,
isBoosted:!1,isForced:!1},u.push(t)}}}}},{"../../keyboard/layout":5,"../../plaintext":8,"../letter":22}],22:[function(e,t,n){"use strict";function a(e,t){return e.charCode-t.charCode}function r(e,t){
return e.f-t.f}Object.defineProperty(n,"__esModule",{value:!0}),n.punctuators=[Object.freeze({charCode:33,f:1}),Object.freeze({charCode:34,f:1}),Object.freeze({charCode:39,f:1}),Object.freeze({
charCode:40,f:1}),Object.freeze({charCode:44,f:1}),Object.freeze({charCode:45,f:1}),Object.freeze({charCode:46,f:1}),Object.freeze({charCode:58,f:1}),Object.freeze({charCode:59,f:1}),Object.freeze({
charCode:63,f:1}),Object.freeze({charCode:91,f:1})],n.filterLetters=function(e,t){for(var n=[],a=0,r=e;a<r.length;a++){var i=r[a];-1!=t.indexOf(i.charCode)&&n.push(i)}return Object.freeze(n)},
n.sortLetters=function(e,t,n){null==t&&(t=a),null==n&&(n=t==r);var i=e.slice();return n?i.sort(function(e,n){return t(n,e)}):i.sort(t),Object.freeze(i)},n.orderByIndex=a,n.orderByFrequency=r},{}],
16:[function(e,t,n){"use strict";function a(e){var t=[],n=i.movingMean(o.WINDOW_SIZE),a=null,r=0,s=null;return{get letter(){return e},get t(){return t},get movingMean(){return n},
get confidenceLevel(){return o.confidenceLevel(n.mean)},get isConfident(){return o.isConfident(n.min)},get deltaTime(){return a},add:function(i){var o=i.histogram[e.charCode]
;null!=o&&o.t>0?(a=o.t-n.mean,t.push(o.t),n.add(o.t),r+=i.time):a=null,s=null},learningRate:function(){if(t.length<10)return null;null==s&&(s=i.linearRegression(t.map(o.timeToSpeed)))
;var e=s.slope,n=60*s.slope*60*1e3/(r/t.length);return{lr:s,perSample:e,perHour:n}}}}Object.defineProperty(n,"__esModule",{value:!0})
;var r=e("../../lib/lang"),i=e("../../lib/math/statistics"),o=e("./result");n.newKeyData=a,n.newStatistics=function(e,t){function n(e,t){i+=e.time,o=e.speed,s=Math.max(s,o),c+=o,d=e.score,
f=Math.max(f,d),m+=d,b=e.errors,v+=b,t>0&&(u=o-l,l=c/t,y=d-p,p=m/t,g=b-h,h=v/t)}for(var i=0,o=0,s=0,c=0,l=0,u=0,d=0,f=0,m=0,p=0,y=0,b=0,v=0,h=0,g=0,k=r.map(),E=0,_=e;E<_.length;E++){
for(var S=_[E],K=a(S),N=t.length,x=0;x<N;x++)K.add(t[x]);k[S.charCode]=K}for(var w=t.length,x=0;x<w;x++)n(t[x],x+1);return{get letters(){return e},get data(){return t},getKeyData:function(e){
var t=k[e.charCode];if(null==t)throw new Error;return t},get keyData(){return Object.values(k)},get totalSamples(){return t.length},get totalTime(){return i},get lastSpeed(){return o},get topSpeed(){
return s},get avgSpeed(){return l},get deltaSpeed(){return u},get lastScore(){return d},get topScore(){return f},get avgScore(){return p},get deltaScore(){return y},get lastErrors(){return b},
get avgErrors(){return h},get deltaErrors(){return g},add:function(a){t.push(a),n(a,t.length);for(var r=0,i=e;r<i.length;r++){var o=i[r];k[o.charCode].add(a)}}}}},{"../../lib/lang":139,
"../../lib/math/statistics":143,"./result":24}],143:[function(e,t,n){"use strict";function a(e){function t(t){r++;var c=t/e;n.push(c),a+=c,n.length<e?i+=(t-i)/r:(i=a,a-=n.shift()),
r>e?(o=Math.min(o,i),s=Math.max(s,i)):(o=i,s=i)}var n=[],a=0,r=0,i=0,o=null,s=null;return{get size(){return e},get n(){return r},get mean(){return i},get min(){return o},get max(){return s},
get available(){return r>=e},add:t,addAll:function(e){for(var n=e.length,a=0;a<n;a++)t(e[a])}}}function r(e){function t(t){if(r++,n.length==e){var i=n.shift();a.remove(a.indexOf(i))}n.push(t),
a.insert(a.search(t),t),o=n.median(),r>e?(s=Math.min(s,o),c=Math.max(c,o)):(s=o,c=o)}var n=i(e),a=i(e),r=0,o=0,s=null,c=null;return{get size(){return e},get n(){return r},get median(){return o},
get min(){return s},get max(){return c},get available(){return r>=e},add:t,addAll:function(e){for(var n=e.length,a=0;a<n;a++)t(e[a])}}}function i(e){var t=new Float64Array(e),n=0;return{get length(){
return n},shift:function(){if(0==n)throw new Error;var e=t[0];return t.copyWithin(0,1,n),n--,e},push:function(e){if(n==t.length)throw new Error;t[n]=e,n++},indexOf:function(e){
for(var a=0;a<n;a++)if(t[a]===e)return a;return-1},remove:function(e){if(0==n)throw new Error;if(e<0||e>=n)throw new Error;var a=t[e];return t.copyWithin(e,e+1,n),n--,a},insert:function(e,a){
if(n==t.length)throw new Error;if(e<0||e>n)throw new Error;t.copyWithin(e+1,e,n),t[e]=a,n++},search:function(e){for(var a=0,r=n-1;r>=a;){var i=a+r>>>1,o=t[i];if(o<e)a=i+1;else{if(!(o>e))return i+1
;r=i-1}}return a},median:function(){if(0==n)throw new Error;var e=n>>>1;return 0!=(1&n)?t[e]:(t[e-1]+t[e])/2}}}Object.defineProperty(n,"__esModule",{value:!0}),n.linearRegression=function(e){
var t=e.length;if(t<3)throw new Error;var n=0,a=0,r=0,i=0,o=0,s=0,c=0,l=0;return function(){var u=.5*(t+1),d=0,f=0,m=0,p=0,y=0,b=0,v=0;for(b=0;b<t;b++)d+=v=e[b],0==b?(n=v,a=v):(n=Math.min(n,v),
a=Math.max(a,v));for(r=d/t,b=0;b<t;b++)f+=(v=e[b]-r)*v;for(i=f/(t-1),b=0;b<t;b++)m+=(v=b-u)*(e[b]-r),p+=v*v;for(o=r-(s=m/p)*u,b=0;b<t;b++)y+=(v=e[b]-(o+b*s))*v;c=y/(t-2),l=1-y/f}(),{get min(){return n
},get max(){return a},get intercept(){return o},get slope(){return s},get meanSquareError(){return c},get RSquare(){return l},fn:function(e){return o+e*s}}},n.mean=function(){function e(e){var s=e-a
;t+=s*(e-(a+=s/++n)),n>1?(r=t/(n-1),i=Math.min(i,e),o=Math.max(o,e)):(i=e,o=e)}var t=0,n=0,a=0,r=null,i=null,o=null;return{get n(){return n},get mean(){return a},get variance(){return r},get min(){
return i},get max(){return o},add:e,addAll:function(t){for(var n=t.length,a=0;a<n;a++)e(t[a])}}},n.movingMean=a,n.movingMedian=r,n.movingMeanSmooth=function(e,t){
for(var n=[],r=a(e),i=t.length,o=0;o<i;o++)r.add(t[o]),r.available&&n.push(r.mean);return n},n.movingMedianSmooth=function(e,t){for(var n=[],a=r(e),i=t.length,o=0;o<i;o++)a.add(t[o]),
a.available&&n.push(a.median);return n}},{}],15:[function(e,t,n){"use strict";function a(e){for(var t=[],n=0;n<e.length;n++){var a=e.charCodeAt(n);-1==t.indexOf(a)&&t.push(a)}return t.length}
function r(){function e(e,t){var n=u[e];null==n&&(n=u[e]={h:0,m:0,t:[]}),n.h++,m&&t&&m<t&&n.t.push(t-m)}function t(e,t){var n=d[e];null==n&&(n=d[e]={h:0,m:0,t:[]}),n.h++,m&&t&&m<t&&n.t.push(t-m)}
function n(e){var t=u[e];null==t&&(t=u[e]={h:0,m:0,t:[]}),t.m++}function a(e){var t=d[e];null==t&&(t=d[e]={h:0,m:0,t:[]}),t.m++}function r(){
...
;var o=e("../../lib/lang"),s=e("../../lib/math/round"),c=e("../../lib/time"),l=e("./result");n.newFragment=function(e,t){function n(){h=null,g=null,k=0,E=0,_=[],S="",K=null,N=[],x=r()}
...
!0):(v()&&x.miss(e),!1)}function d(e,t,n){return S.length>0?(S.length<30&&(S+=String.fromCharCode(t)),!1):e==t?(x.hit(e,n),k++,!0):(v()&&x.miss(e),S=String.fromCharCode(t),!1)}function f(){N=[]}
function m(){}function p(){S.length>0&&(S=S.substring(0,S.length-1))}function y(){for(var e=0;e<N.length;e++)if(t.charCodeAt(k+1+e)!=N[e].charCode)return!1;return!0}function b(){
for(var e=1;e<N.length;e++)if(t.charCodeAt(k+e)!=N[e].charCode)return!1;return!0}function v(){return-1==_.indexOf(k)&&(E++,_.push(k),!0)}
var h,g,k,E,_,S,K,N,x,w=3,O=e.stopOnError,D=e.forgiving,C=e.modeKey,M=e.clock||c.systemClock,I=a(t);if(0==t.length)throw new Error;return n(),{reset:n,step:function(e){if(null!=K)throw new Error
;var n=t.charCodeAt(k);if(0==k&&0==S.length&&(8==e||9==e||10==e||32==e))return{elapsed:0,hit:null,expected:n,actual:e,result:null};var a=M.now();if(null==h&&(h=a),g=a-h,8==e)return o(),{elapsed:g,
hit:null,expected:n,actual:e,result:null};var r=i(n,e,a);return k==t.length&&(K=l.newResult(C,h,t.length,g,E,I,x.build())),{elapsed:g,hit:r,expected:n,actual:e,result:K}},get text(){return t},
get position(){return k},get errors(){return E},get errorPositions(){return _},get garbage(){return S}}},n.newHistogramBuilder=r},{"../../lib/lang":139,"../../lib/math/round":142,"../../lib/time":158,
...
var k=n.getUint16(),E=n.getUint8(),_=n.getUint8(),S=n.getUint32()/1e3;h[k]={h:E,m:_,t:S}}var K=d.newResult(f.getModeKeyByXid(a,r),1e3*i+o,l,c,m,p,h);d.validateResult(K)&&t.push(K)}return t}
Object.defineProperty(n,"__esModule",{value:!0})
...
for(var t in e){var n=e[t];if(0!=n.t&&n.t<40)return!1}return!0}Object.defineProperty(n,"__esModule",{value:!0}),n.MIN_SIZE=6,n.MIN_TIME=340,n.MAX_TIME=1e3,n.WINDOW_SIZE=20,n.timeToSpeed=function(e){
return null==e||0==e?null:6e4/e},n.confidenceLevel=function(e){return null==e||0==e?null:(e=Math.max(e,n.MIN_TIME),e=Math.min(e,n.MAX_TIME),1-(e=(e-n.MIN_TIME)/(n.MAX_TIME-n.MIN_TIME)))},
n.isConfident=function(e){return null==e||0==e?null:e<=n.MIN_TIME},n.newResult=function(e,t,n,a,r,i,o){var s=0,c=0;return a>1&&n>1&&i>1&&(c=(s=n/(a/1e3)*60)*i/(r+1)*(n/50)),{modeKey:e,timeStamp:t,
length:n,time:a,errors:r,complexity:i,speed:s,score:c,histogram:o}},n.validateResult=function(e){return e.time>1&&e.length>1&&e.complexity>1&&e.speed>1&&e.speed<1500&&a(e.histogram)},
n.validateHistogram=a,n.transition=function(e,t){return(65535&e)<<16|65535&t},n.transitionFrom=function(e){return e>>>16&65535},n.transitionTo=function(e){return 65535&e}},{}],10:[function(e,t,n){
"use strict";Object.defineProperty(n,"__esModule",{value:!0});var a=e("../../lib/lang"),r=e("./settings");n.newDataMap=function(e){for(var t=a.map(),n=0,i=e;n<i.length;n++){
var o=i[n],s=String(o.modeKey),c=t[s];null==c&&(c=t[s]=[]),c.push(o)}return{data:function(){return e},keySet:function(){return Object.keys(t).map(r.parseModeKey)},dataForKey:function(e){
var n=String(e),a=t[n];return null==a&&(a=t[n]=[]),a}}}},{"../../lib/lang":139,"./settings":25}],25:[function(e,t,n){"use strict";function a(e,t){if(null==e||null==t)throw new Error
;var n=e.id+":"+t.id,a=h[n];return null==a&&(a=h[n]=Object.freeze({layout:e,modeType:t,key:n,name:t.name+" / "+e.name,toString:function(){return n}})),a}function r(e,t){
return a(v.byId(b.getLayoutSet(),e),v.byId(n.MODE_TYPE,t))}function i(e,t){return e.load((n={},n[g]=null,n)).then(function(n){var a=n[g];return null!=a?(c(t,a),t.newSettings=!1,null):(c(t,{}),
t.newSettings=!0,o(e,t))});var n}function o(e,t){return e.store((n={},n[g]=s(t),n));var n}function s(e){return{layout:e.layout.id,emulateLayout:e.emulateLayout,mode:e.mode.id,lesson:{
...
y.isObject(t.text)||(t.text={}),y.isObject(t.text.mangle)||(t.text.mangle={}),e.layout=v.byId(b.getLayoutSet(),t.layout,b.getDefaultLayout()),e.emulateLayout=l(t.emulateLayout,!1),
...
return a(v.byXId(b.getLayoutSet(),e),v.byXId(n.MODE_TYPE,t))},n.parseModeKey=function(e){var t=e.indexOf(":");if(-1==t)throw new Error;return r(e.substring(0,t),e.substring(t+1))},
n.newSettings=function(e){var t=b.getDefaultLayout(),r=!1,s=n.MODE.GUIDED,c=0,l=0,u=!1,d=!1,p={get complexity(){return c},set complexity(e){c=e},get length(){return l},set length(e){l=e},
...
set lowercase(e){v=e}},g="",k="",E={get url(){return g},set url(e){g=m(e)||""},get content(){return k},set content(e){k=f(e)||""},get mangle(){return h}},_=!0,S=n.SPEED_UNIT.WPM,K=!1,N=!0,x={
...
get text(){return E},get stopOnError(){return _},set stopOnError(e){_=e},get speedUnit(){return S},set speedUnit(e){S=e},get enableSound(){return K},set enableSound(e){K=e},get newSettings(){return N
...
null!=e&&null!=e.id||(e=c);for(var t=0,n=["facebook","google"];t<n.length;t++){var a=n[t],r=e.externalId[a];if(r)return{id:e.id,name:r.fullName||r.userName,imageUrl:r.imageUrl}}return{id:e.id,
...
function r(e){var t=e.className,n=e.title,a=e.name,r=l("Name",t);return u.createElement("span",{className:r,title:n},a+":")}function i(e){return u.isValidElement(e)?e:u.createElement(o,{value:e})}
function o(e){var t=e.className,n=e.title,a=e.value,r=l("Value",t);return u.createElement("span",{className:r,title:n},a)}function s(e){
var t=e.className,n=e.title,a=e.value,r=e.invert,i=l("ValueDelta",a>0&&(r?"ValueDelta--less":"ValueDelta--more"),a<0&&(r?"ValueDelta--more":"ValueDelta--less"),0==a&&"ValueDelta--zero",t)
;return u.createElement("span",{className:i,title:n},c(a))}function c(e){var t=String(e);return e>0?"+"+t:t}Object.defineProperty(n,"__esModule",{value:!0});var l=e("classnames"),u=e("react")
;n.NameValue=function(e){var t=e.className,n=e.title,r=e.name,o=e.value,s=l("NameValue",t);return u.createElement("span",{className:s,title:n},a(r),i(o))},n.asName=a,n.Name=r,n.asValue=i,n.Value=o,
n.asValueDelta=function(e){return u.isValidElement(e)?e:u.createElement(s,{value:e})},n.ValueDelta=s,n.Indicator=function(e){var t=e.className,n=e.title,a=e.name,r=e.value
;return u.createElement("div",{className:l("Indicator",t),title:n},u.createElement("span",{className:"Indicator-name"},String(a)+":"),u.createElement("span",{className:"Indicator-value"},String(r)))}
},{classnames:"classnames",react:"react"}],142:[function(e,t,n){"use strict";Object.defineProperty(n,"__esModule",{value:!0}),n.default=function(e,t){return Math.round(e*t)/t}},{}],
125:[function(e,t,n){"use strict";function a(e,t){for(var n=i(e),a=4;a<t.length;a++)t[a]=t[a]^n()}function r(){return Math.floor(4294967296*l.random())}function i(e){var t=c(e,2147483629)+12820163>>>0
;return function(){return t=c(t,1664525)+1013904223>>>0}}function o(e,t){return(e[t+0]<<24>>>0|e[t+1]<<16>>>0|e[t+2]<<8>>>0|e[t+3]<<0>>>0)>>>0}function s(e,t,n){e[t+0]=n>>>24,e[t+1]=n>>>16,
e[t+2]=n>>>8,e[t+3]=n>>>0}function c(e,t){e>>>=0,t>>>=0;for(var n=0,a=0;a<32;a++)1==(t>>>a&1)&&(n+=e<<a);return n>>>0}Object.defineProperty(n,"__esModule",{value:!0})
;var l=e("../math/random"),u=e("./crc32");n.encode=function(e){var t=r(),n=new Uint8Array(e.length+8);return s(n,0,t),s(n,4,u.crc32(e)),n.set(e,8),a(t,n),n},n.decode=function(e){
if(e.length<8)throw new Error;a(o(e,0),e);var t=o(e,4),n=e.slice(8);if(u.crc32(n)!=t)throw new Error;return n}},{"../math/random":141,"./crc32":123}],141:[function(e,t,n){"use strict";function a(){
return Math.random()}function r(e,t){var n=Math.sqrt(3*t),r=2*n;return e+(a()*r-n+(a()*r-n)+(a()*r-n)+(a()*r-n)+(a()*r-n))/5*2.23606797749979}Object.defineProperty(n,"__esModule",{value:!0}),
n.random=a,n.normal=function(e,t,n){if(!(Number.isFinite(n)&&n>0))return r(e,t);for(;;){var a=r(e,t);if(Math.abs(a-e)<n)return a}},n.pick=function(e){if(0==e.length)throw new Error
;return e[Math.floor(a()*e.length)]},n.pickWeighted=function(e,t){if(0==e.length)throw new Error;for(var n=0,r=0,i=e;r<i.length;r++)n+=t(l=i[r]);for(var o=a()*n,s=0,c=e;s<c.length;s++){
var l=c[s],u=t(l);if(o<=u)return l;o-=u}throw new Error}},{}],124:[function(e,t,n){"use strict";Object.defineProperty(n,"__esModule",{value:!0});var a=e("./crc32"),r=e("./utf8"),i=function(){
function e(e){void 0===e&&(e=64),this.dataView=new DataView(new ArrayBuffer(Math.max(e,64))),this.byteOffset=0}return e.prototype.ensureSize=function(e){if(this.dataView.byteLength<e){
for(var t=64;t<e;)t*=t;var n=new ArrayBuffer(t);new Uint8Array(n).set(new Uint8Array(this.dataView.buffer)),this.dataView=new DataView(n)}},e.prototype.ensureAvailable=function(e){
this.ensureSize(this.byteOffset+e)},e.prototype.putString=function(e){var t=r.size(e);return this.putUint16(t),this.ensureAvailable(t),r.encode(e,this.dataView,this.byteOffset),this.byteOffset+=t,this
},e.prototype.putInt8=function(e){return this.ensureAvailable(1),this.dataView.setInt8(this.byteOffset,e),this.byteOffset+=1,this},e.prototype.putUint8=function(e){return this.ensureAvailable(1),
...
for(var t=e.text,n=e.position,a=e.errorPositions,i=e.garbage,s=[],c=0;c<t.length;c++)i&&c==n&&s.push(d.createElement(S,{key:"garbage",garbage:i})),o(s,t,c,!0,r(c,n,a));return d.createElement("div",{
...
garbage:o})},t}(d.Component),S=function(e){function t(){return null!==e&&e.apply(this,arguments)||this}return c.__extends(t,e),t.prototype.render=function(){
...
for(var y=[],b=s.map(),v=s.map(),h=s.map(),g=0,k=Object.entries(c);g<k.length;g++){var E=k[g],_=E[0],S=E[1],K=u[_];if(null!=K){var N=r(_,S.vk,0|S.a,0|S.b,0|S.c,0|S.d,K.x,K.y,K.shape,K.zone||null)
...
;var s=e("../../lib/lang"),c=e("../../lib/runtime/platform"),l=e("../../lib/unicode"),u=e("../util/enum"),d=e("../../data/layout"),f=e("./language"),m=Object.freeze(function(){
for(var e=s.map(),t=0,n=d.LAYOUT_LIST;t<n.length;t++){var r=n[t];if(c.platform.match(r.platform)){
var i=u.byId(f.LANGUAGE,r.language),o=u.byId(e,r.variantOf,null),l=a(r.id,r.xid,r.name,i,r.keySet,r.geometry,o);if(null!=e[l.id])throw new Error;e[l.id]=l}}return e}());n.getLayoutSet=function(){
return m},n.getDefaultLayout=function(){return m[Object.keys(m)[0]]},n.newLayout=a,n.layoutCharCodes=function(e,t){
...
i(n.DIACRITIC_TILDE,n.COMBINING_DIACRITIC_TILDE,"AaEeIiNnOoUuVvYy","ÃãẼẽĨĩÑñÕõŨũṼṽỸỹ")},{"./lang":139}],146:[function(e,t,n){"use strict";function a(e){
var t=/(\bWindows\b|\bWin32\b|\bWin64\b)/i.test(e)?n.OS_WINDOWS:/(\bMac\b|\biPhone\b|\biPad\b)/i.test(e)?n.OS_OSX:/(\bLinux\b)/i.test(e)?n.OS_LINUX:n.UNKNOWN,a=/(\bEdge\b)/i.test(e)?n.BROWSER_EDGE:/(\bTrident\b)/i.test(e)?n.BROWSER_TRIDENT:/(\bFirefox\b)/i.test(e)?n.BROWSER_FIREFOX:/(\bChrome\b)/i.test(e)?n.BROWSER_CHROME:/(\bSafari\b)/i.test(e)?n.BROWSER_SAFARI:n.UNKNOWN,i=r.DOCUMENT.createEvent("KeyboardEvent"),o=n.SPECIFICATION_LEGACY
;return"code"in i&&"key"in i&&(o=n.SPECIFICATION_MODERN),console.log("OS family: "+t+"; Browser family: "+a+"; Keyboard events specification: "+o),{os:t,browser:a,specification:o,match:function(e){
return null==e||"any"==e||e==t}}}Object.defineProperty(n,"__esModule",{value:!0});var r=e("./global");n.OS_WINDOWS="windows",n.OS_OSX="osx",n.OS_LINUX="linux",n.BROWSER_EDGE="edge",
n.BROWSER_TRIDENT="trident",n.BROWSER_FIREFOX="firefox",n.BROWSER_CHROME="chrome",n.BROWSER_SAFARI="safari",n.UNKNOWN="unknown",n.SPECIFICATION_LEGACY="legacy",n.SPECIFICATION_MODERN="modern",
n.platform=a(r.WINDOW.navigator.userAgent),n.newPlatform=a},{"./global":145}],145:[function(e,t,n){"use strict";Object.defineProperty(n,"__esModule",{value:!0}),n.WINDOW=window,n.DOCUMENT=document,
n.ROOT_ELEMENT=document.documentElement,n.HEAD_ELEMENT=document.head,n.BODY_ELEMENT=document.body},{}],62:[function(e,t,n){"use strict";Object.defineProperty(n,"__esModule",{value:!0})
;var a=e("../lib/lang"),r=e("./geometry"),i=a.map(e("./layout/english_us.json"));n.KEY_SET_ENGLISH_US=i;var o=a.map(e("./layout/english_us_international-win.json"))
;n.KEY_SET_ENGLISH_US_INTERNATIONAL_WIN=o;var s=a.map(e("./layout/english_uk-win.json"));n.KEY_SET_ENGLISH_UK_WIN=s;var c=a.map(e("./layout/english_uk-osx.json"));n.KEY_SET_ENGLISH_UK_OSX=c
;var l=a.map(e("./layout/english_uk_extended-win.json"));n.KEY_SET_ENGLISH_UK_EXTENDED_WIN=l;var u=a.map(e("./layout/english_us_dvorak.json"));n.KEY_SET_ENGLISH_US_DVORAK=u
;var d=a.map(e("./layout/english_us_dvorak_left_handed.json"));n.KEY_SET_ENGLISH_US_DVORAK_LEFT_HANDED=d;var f=a.map(e("./layout/english_us_dvorak_right_handed.json"))
;n.KEY_SET_ENGLISH_US_DVORAK_RIGHT_HANDED=f;var m=a.map(e("./layout/english_us_colemak.json"));n.KEY_SET_ENGLISH_US_COLEMAK=m;var p=a.map(e("./layout/english_us_workman.json"))
;n.KEY_SET_ENGLISH_US_WORKMAN=p;var y=a.map(e("./layout/german-win.json"));n.KEY_SET_GERMAN_WIN=y;var b=a.map(e("./layout/german_switzerland-win.json"));n.KEY_SET_GERMAN_SWITZERLAND_WIN=b
;var v=a.map(e("./layout/french-win.json"));n.KEY_SET_FRENCH_WIN=v;var h=a.map(e("./layout/french_canada-win.json"));n.KEY_SET_FRENCH_CANADA_WIN=h
;var g=a.map(e("./layout/french_switzerland-win.json"));n.KEY_SET_FRENCH_SWITZERLAND_WIN=g;var k=a.map(e("./layout/italian-win.json"));n.KEY_SET_ITALIAN_WIN=k
;var E=a.map(e("./layout/spanish-win.json"));n.KEY_SET_SPANISH_WIN=E;var _=a.map(e("./layout/spanish_variation-win.json"));n.KEY_SET_SPANISH_VARIATION_WIN=_
;var S=a.map(e("./layout/portuguese-win.json"));n.KEY_SET_PORTUGUESE_WIN=S;var K=a.map(e("./layout/portuguese_brazilian_abtn2-win.json"));n.KEY_SET_PORTUGUESE_BRAZILIAN_ABTN2_WIN=K
;var N=a.map(e("./layout/russian-win.json"));n.KEY_SET_RUSSIAN_WIN=N;var x=a.map(e("./layout/russian-osx.json"));n.KEY_SET_RUSSIAN_OSX=x;var w=a.map(e("./layout/russian_typewriter-win.json"))
;n.KEY_SET_RUSSIAN_TYPEWRITER_WIN=w,n.LAYOUT_LIST=[{id:"us",xid:16,name:"US",language:"en",keySet:i,geometry:r.STANDARD_101,variantOf:null,platform:null},{id:"uk",xid:17,name:"UK",language:"en",
keySet:s,geometry:r.STANDARD_102,variantOf:null,platform:"windows"},{id:"uk",xid:17,name:"UK",language:"en",keySet:c,geometry:r.STANDARD_101,variantOf:null,platform:"osx"},{id:"uk",xid:17,name:"UK",
language:"en",keySet:s,geometry:r.STANDARD_102,variantOf:null,platform:"linux"},{id:"us-dvorak",xid:24,name:"US Dvorak",language:"en",keySet:u,geometry:r.STANDARD_101,variantOf:"us",platform:null},{
id:"us-colemak",xid:25,name:"US Colemak",language:"en",keySet:m,geometry:r.STANDARD_101,variantOf:"us",platform:null},{id:"us-workman",xid:26,name:"US Workman",language:"en",keySet:p,
geometry:r.STANDARD_101,variantOf:"us",platform:null},{id:"de",xid:32,name:"Germany",language:"de",keySet:y,geometry:r.STANDARD_102,variantOf:null,platform:"windows"},{id:"de",xid:32,name:"Germany",
language:"de",keySet:y,geometry:r.STANDARD_102,variantOf:null,platform:"osx"},{id:"de",xid:32,name:"Germany",language:"de",keySet:y,geometry:r.STANDARD_102,variantOf:null,platform:"linux"},{
id:"de-ch",xid:33,name:"Switzerland",language:"de",keySet:b,geometry:r.STANDARD_102,variantOf:null,platform:"windows"},{id:"de-ch",xid:33,name:"Switzerland",language:"de",keySet:b,
geometry:r.STANDARD_102,variantOf:null,platform:"osx"},{id:"de-ch",xid:33,name:"Switzerland",language:"de",keySet:b,geometry:r.STANDARD_102,variantOf:null,platform:"linux"},{id:"fr",xid:48,
name:"France",language:"fr",keySet:v,geometry:r.STANDARD_102,variantOf:null,platform:"windows"},{id:"fr",xid:48,name:"France",language:"fr",keySet:v,geometry:r.STANDARD_102,variantOf:null,
platform:"osx"},{id:"fr",xid:48,name:"France",language:"fr",keySet:v,geometry:r.STANDARD_102,variantOf:null,platform:"linux"},{id:"fr-ca",xid:49,name:"Canada",language:"fr",keySet:h,
geometry:r.STANDARD_102,variantOf:null,platform:"windows"},{id:"fr-ca",xid:49,name:"Canada",language:"fr",keySet:h,geometry:r.STANDARD_102,variantOf:null,platform:"osx"},{id:"fr-ca",xid:49,
name:"Canada",language:"fr",keySet:h,geometry:r.STANDARD_102,variantOf:null,platform:"linux"},{id:"fr-ch",xid:50,name:"Switzerland",language:"fr",keySet:g,geometry:r.STANDARD_102,variantOf:null,
platform:"windows"},{id:"fr-ch",xid:50,name:"Switzerland",language:"fr",keySet:g,geometry:r.STANDARD_102,variantOf:null,platform:"osx"},{id:"fr-ch",xid:50,name:"Switzerland",language:"fr",keySet:g,
geometry:r.STANDARD_102,variantOf:null,platform:"linux"},{id:"it",xid:64,name:"Italy",language:"it",keySet:k,geometry:r.STANDARD_102,variantOf:null,platform:"windows"},{id:"it",xid:64,name:"Italy",
language:"it",keySet:k,geometry:r.STANDARD_102,variantOf:null,platform:"osx"},{id:"it",xid:64,name:"Italy",language:"it",keySet:k,geometry:r.STANDARD_102,variantOf:null,platform:"linux"},{id:"es",
xid:80,name:"Spanish",language:"es",keySet:E,geometry:r.STANDARD_102,variantOf:null,platform:"windows"},{id:"es-variation",xid:81,name:"Spanish Variation",language:"es",keySet:_,
geometry:r.STANDARD_102,variantOf:null,platform:"windows"},{id:"pt-br",xid:96,name:"Brazilian ABNT2",language:"pt",keySet:K,geometry:r.STANDARD_102,variantOf:null,platform:"windows"},{id:"pt-br",
xid:96,name:"Brazilian ABNT2",language:"pt",keySet:K,geometry:r.STANDARD_102,variantOf:null,platform:"osx"},{id:"pt-br",xid:96,name:"Brazilian ABNT2",language:"pt",keySet:K,geometry:r.STANDARD_102,
variantOf:null,platform:"linux"},{id:"pt-pt",xid:98,name:"Portugal",language:"pt",keySet:S,geometry:r.STANDARD_102,variantOf:null,platform:"windows"},{id:"pt-pt",xid:98,name:"Portugal",language:"pt",
keySet:S,geometry:r.STANDARD_102,variantOf:null,platform:"osx"},{id:"pt-pt",xid:98,name:"Portugal",language:"pt",keySet:S,geometry:r.STANDARD_102,variantOf:null,platform:"linux"},{id:"ru",xid:112,
name:"Russian",language:"ru",keySet:N,geometry:r.STANDARD_102,variantOf:null,platform:"windows"},{id:"ru",xid:112,name:"Russian",language:"ru",keySet:x,geometry:r.STANDARD_101,variantOf:null,
platform:"osx"},{id:"ru",xid:112,name:"Russian",language:"ru",keySet:N,geometry:r.STANDARD_102,variantOf:null,platform:"linux"},{id:"ru-typewriter",xid:113,name:"Russian (Typewriter)",language:"ru",
keySet:w,geometry:r.STANDARD_102,variantOf:null,platform:"windows"}]},{"../lib/lang":139,"./geometry":56,"./layout/english_uk-osx.json":63,"./layout/english_uk-win.json":64,
"./layout/english_uk_extended-win.json":65,"./layout/english_us.json":66,"./layout/english_us_colemak.json":67,"./layout/english_us_dvorak.json":68,"./layout/english_us_dvorak_left_handed.json":69,
"./layout/english_us_dvorak_right_handed.json":70,"./layout/english_us_international-win.json":71,"./layout/english_us_workman.json":72,"./layout/french-win.json":73,
"./layout/french_canada-win.json":74,"./layout/french_switzerland-win.json":75,"./layout/german-win.json":76,"./layout/german_switzerland-win.json":77,"./layout/italian-win.json":78,
"./layout/portuguese-win.json":79,"./layout/portuguese_brazilian_abtn2-win.json":80,"./layout/russian-osx.json":81,"./layout/russian-win.json":82,"./layout/russian_typewriter-win.json":83,
"./layout/spanish-win.json":84,"./layout/spanish_variation-win.json":85}],85:[function(e,t,n){t.exports={Backquote:{vk:220,a:39,b:183,c:92,d:0},Digit1:{vk:49,a:49,b:170,c:124,d:0},Digit2:{vk:50,a:50,
b:34,c:64,d:0},Digit3:{vk:51,a:51,b:47,c:35,d:0},Digit4:{vk:52,a:52,b:40,c:188,d:0},Digit5:{vk:53,a:53,b:41,c:189,d:0},Digit6:{vk:54,a:54,b:161,c:172,d:0},Digit7:{vk:55,a:55,b:33,c:95,d:0},Digit8:{
vk:56,a:56,b:191,c:35,d:0},Digit9:{vk:57,a:57,b:63,c:167,d:0},Digit0:{vk:48,a:48,b:8359,c:92,d:0},Minus:{vk:189,a:45,b:43,c:42,d:0},Equal:{vk:219,a:776,b:776,c:771,d:0},KeyQ:{vk:81,a:113,b:81,c:0,d:0
},KeyW:{vk:87,a:119,b:87,c:0,d:0},KeyE:{vk:69,a:101,b:69,c:8364,d:0},KeyR:{vk:82,a:114,b:82,c:0,d:0},KeyT:{vk:84,a:116,b:84,c:0,d:0},KeyY:{vk:89,a:121,b:89,c:0,d:0},KeyU:{vk:85,a:117,b:85,c:0,d:0},
KeyI:{vk:73,a:105,b:73,c:0,d:0},KeyO:{vk:79,a:111,b:79,c:0,d:0},KeyP:{vk:80,a:112,b:80,c:0,d:0},BracketLeft:{vk:221,a:247,b:215,c:91,d:0},BracketRight:{vk:186,a:768,b:768,c:93,d:0},Backslash:{vk:191,
a:769,b:769,c:125,d:0},KeyA:{vk:65,a:97,b:65,c:36,d:0},KeyS:{vk:83,a:115,b:83,c:38,d:0},KeyD:{vk:68,a:100,b:68,c:64,d:0},KeyF:{vk:70,a:102,b:70,c:91,d:0},KeyG:{vk:71,a:103,b:71,c:93,d:0},KeyH:{vk:72,
a:104,b:72,c:124,d:0},KeyJ:{vk:74,a:106,b:74,c:163,d:0},KeyK:{vk:75,a:107,b:75,c:177,d:0},KeyL:{vk:76,a:108,b:76,c:0,d:0},Semicolon:{vk:192,a:241,b:209,c:126,d:0},Quote:{vk:222,a:231,b:199,c:123,d:0},
...
vk:77,a:109,b:77,c:0,d:0},Comma:{vk:188,a:44,b:59,c:0,d:0},Period:{vk:190,a:46,b:58,c:770,d:0},Slash:{vk:223,a:61,b:37,c:0,d:0},IntlBackslash:{vk:226,a:60,b:62,c:0,d:0}}},{}],84:[function(e,t,n){
t.exports={Backquote:{vk:220,a:186,b:170,c:92,d:0},Digit1:{vk:49,a:49,b:33,c:124,d:0},Digit2:{vk:50,a:50,b:34,c:64,d:0},Digit3:{vk:51,a:51,b:183,c:35,d:0},Digit4:{vk:52,a:52,b:36,c:771,d:0},Digit5:{
vk:53,a:53,b:37,c:8364,d:0},Digit6:{vk:54,a:54,b:38,c:172,d:0},Digit7:{vk:55,a:55,b:47,c:0,d:0},Digit8:{vk:56,a:56,b:40,c:0,d:0},Digit9:{vk:57,a:57,b:41,c:0,d:0},Digit0:{vk:48,a:48,b:61,c:0,d:0},
Minus:{vk:219,a:39,b:63,c:0,d:0},Equal:{vk:221,a:161,b:191,c:0,d:0},KeyQ:{vk:81,a:113,b:81,c:0,d:0},KeyW:{vk:87,a:119,b:87,c:0,d:0},KeyE:{vk:69,a:101,b:69,c:8364,d:0},KeyR:{vk:82,a:114,b:82,c:0,d:0},
KeyT:{vk:84,a:116,b:84,c:0,d:0},KeyY:{vk:89,a:121,b:89,c:0,d:0},KeyU:{vk:85,a:117,b:85,c:0,d:0},KeyI:{vk:73,a:105,b:73,c:0,d:0},KeyO:{vk:79,a:111,b:79,c:0,d:0},KeyP:{vk:80,a:112,b:80,c:0,d:0},
BracketLeft:{vk:186,a:768,b:770,c:91,d:0},BracketRight:{vk:187,a:43,b:42,c:93,d:0},Backslash:{vk:191,a:231,b:199,c:125,d:0},KeyA:{vk:65,a:97,b:65,c:0,d:0},KeyS:{vk:83,a:115,b:83,c:0,d:0},KeyD:{vk:68,
...
b:76,c:0,d:0},Semicolon:{vk:192,a:241,b:209,c:0,d:0},Quote:{vk:222,a:769,b:776,c:123,d:0},KeyZ:{vk:90,a:122,b:90,c:0,d:0},KeyX:{vk:88,a:120,b:88,c:0,d:0},KeyC:{vk:67,a:99,b:67,c:0,d:0},KeyV:{vk:86,
...
a:45,b:95,c:0,d:0},IntlBackslash:{vk:226,a:60,b:62,c:0,d:0}}},{}],83:[function(e,t,n){t.exports={Backquote:{vk:192,a:124,b:43,c:0,d:0},Digit1:{vk:49,a:8470,b:49,c:0,d:0},Digit2:{vk:50,a:45,b:50,c:0,
d:0},Digit3:{vk:51,a:47,b:51,c:0,d:0},Digit4:{vk:52,a:34,b:52,c:0,d:0},Digit5:{vk:53,a:58,b:53,c:0,d:0},Digit6:{vk:54,a:44,b:54,c:0,d:0},Digit7:{vk:55,a:46,b:55,c:0,d:0},Digit8:{vk:56,a:95,b:56,
c:8381,d:0},Digit9:{vk:57,a:63,b:57,c:0,d:0},Digit0:{vk:48,a:37,b:48,c:0,d:0},Minus:{vk:189,a:33,b:61,c:0,d:0},Equal:{vk:187,a:59,b:92,c:0,d:0},KeyQ:{vk:81,a:1081,b:1049,c:0,d:0},KeyW:{vk:87,a:1094,
b:1062,c:0,d:0},KeyE:{vk:69,a:1091,b:1059,c:0,d:0},KeyR:{vk:82,a:1082,b:1050,c:0,d:0},KeyT:{vk:84,a:1077,b:1045,c:0,d:0},KeyY:{vk:89,a:1085,b:1053,c:0,d:0},KeyU:{vk:85,a:1075,b:1043,c:0,d:0},KeyI:{
vk:73,a:1096,b:1064,c:0,d:0},KeyO:{vk:79,a:1097,b:1065,c:0,d:0},KeyP:{vk:80,a:1079,b:1047,c:0,d:0},BracketLeft:{vk:219,a:1093,b:1061,c:0,d:0},BracketRight:{vk:221,a:1098,b:1066,c:0,d:0},Backslash:{
vk:220,a:41,b:40,c:0,d:0},KeyA:{vk:65,a:1092,b:1060,c:0,d:0},KeyS:{vk:83,a:1099,b:1067,c:0,d:0},KeyD:{vk:68,a:1074,b:1042,c:0,d:0},KeyF:{vk:70,a:1072,b:1040,c:0,d:0},KeyG:{vk:71,a:1087,b:1055,c:0,d:0
},KeyH:{vk:72,a:1088,b:1056,c:0,d:0},KeyJ:{vk:74,a:1086,b:1054,c:0,d:0},KeyK:{vk:75,a:1083,b:1051,c:0,d:0},KeyL:{vk:76,a:1076,b:1044,c:0,d:0},Semicolon:{vk:186,a:1078,b:1046,c:0,d:0},Quote:{vk:222,
a:1101,b:1069,c:0,d:0},KeyZ:{vk:90,a:1103,b:1071,c:0,d:0},KeyX:{vk:88,a:1095,b:1063,c:0,d:0},KeyC:{vk:67,a:1089,b:1057,c:0,d:0},KeyV:{vk:86,a:1084,b:1052,c:0,d:0},KeyB:{vk:66,a:1080,b:1048,c:0,d:0},
KeyN:{vk:78,a:1090,b:1058,c:0,d:0},KeyM:{vk:77,a:1100,b:1068,c:0,d:0},Comma:{vk:188,a:1073,b:1041,c:0,d:0},Period:{vk:190,a:1102,b:1070,c:0,d:0},Slash:{vk:191,a:1105,b:1025,c:0,d:0},IntlBackslash:{
vk:226,a:41,b:40,c:0,d:0}}},{}],82:[function(e,t,n){t.exports={Backquote:{vk:192,a:1105,b:1025,c:0,d:0},Digit1:{vk:49,a:49,b:33,c:0,d:0},Digit2:{vk:50,a:50,b:34,c:0,d:0},Digit3:{vk:51,a:51,b:8470,c:0,
d:0},Digit4:{vk:52,a:52,b:59,c:0,d:0},Digit5:{vk:53,a:53,b:37,c:0,d:0},Digit6:{vk:54,a:54,b:58,c:0,d:0},Digit7:{vk:55,a:55,b:63,c:0,d:0},Digit8:{vk:56,a:56,b:42,c:8381,d:0},Digit9:{vk:57,a:57,b:40,
c:0,d:0},Digit0:{vk:48,a:48,b:41,c:0,d:0},Minus:{vk:189,a:45,b:95,c:0,d:0},Equal:{vk:187,a:61,b:43,c:0,d:0},KeyQ:{vk:81,a:1081,b:1049,c:0,d:0},KeyW:{vk:87,a:1094,b:1062,c:0,d:0},KeyE:{vk:69,a:1091,
b:1059,c:0,d:0},KeyR:{vk:82,a:1082,b:1050,c:0,d:0},KeyT:{vk:84,a:1077,b:1045,c:0,d:0},KeyY:{vk:89,a:1085,b:1053,c:0,d:0},KeyU:{vk:85,a:1075,b:1043,c:0,d:0},KeyI:{vk:73,a:1096,b:1064,c:0,d:0},KeyO:{
vk:79,a:1097,b:1065,c:0,d:0},KeyP:{vk:80,a:1079,b:1047,c:0,d:0},BracketLeft:{vk:219,a:1093,b:1061,c:0,d:0},BracketRight:{vk:221,a:1098,b:1066,c:0,d:0},Backslash:{vk:220,a:92,b:47,c:0,d:0},KeyA:{vk:65,
a:1092,b:1060,c:0,d:0},KeyS:{vk:83,a:1099,b:1067,c:0,d:0},KeyD:{vk:68,a:1074,b:1042,c:0,d:0},KeyF:{vk:70,a:1072,b:1040,c:0,d:0},KeyG:{vk:71,a:1087,b:1055,c:0,d:0},KeyH:{vk:72,a:1088,b:1056,c:0,d:0},
KeyJ:{vk:74,a:1086,b:1054,c:0,d:0},KeyK:{vk:75,a:1083,b:1051,c:0,d:0},KeyL:{vk:76,a:1076,b:1044,c:0,d:0},Semicolon:{vk:186,a:1078,b:1046,c:0,d:0},Quote:{vk:222,a:1101,b:1069,c:0,d:0},KeyZ:{vk:90,
a:1103,b:1071,c:0,d:0},KeyX:{vk:88,a:1095,b:1063,c:0,d:0},KeyC:{vk:67,a:1089,b:1057,c:0,d:0},KeyV:{vk:86,a:1084,b:1052,c:0,d:0},KeyB:{vk:66,a:1080,b:1048,c:0,d:0},KeyN:{vk:78,a:1090,b:1058,c:0,d:0},
KeyM:{vk:77,a:1100,b:1068,c:0,d:0},Comma:{vk:188,a:1073,b:1041,c:0,d:0},Period:{vk:190,a:1102,b:1070,c:0,d:0},Slash:{vk:191,a:46,b:44,c:0,d:0},IntlBackslash:{vk:226,a:92,b:47,c:0,d:0}}},{}],
81:[function(e,t,n){t.exports={Backquote:{vk:192,a:93,b:91,c:0,d:0},Digit1:{vk:49,a:49,b:33,c:0,d:0},Digit2:{vk:50,a:50,b:34,c:0,d:0},Digit3:{vk:51,a:51,b:8470,c:0,d:0},Digit4:{vk:52,a:52,b:37,c:0,d:0
},Digit5:{vk:53,a:53,b:58,c:0,d:0},Digit6:{vk:54,a:54,b:44,c:0,d:0},Digit7:{vk:55,a:55,b:46,c:0,d:0},Digit8:{vk:56,a:56,b:59,c:0,d:0},Digit9:{vk:57,a:57,b:40,c:0,d:0},Digit0:{vk:48,a:48,b:41,c:0,d:0},
Minus:{vk:189,a:45,b:95,c:0,d:0},Equal:{vk:187,a:61,b:43,c:0,d:0},KeyQ:{vk:81,a:1081,b:1049,c:0,d:0},KeyW:{vk:87,a:1094,b:1062,c:0,d:0},KeyE:{vk:69,a:1091,b:1059,c:0,d:0},KeyR:{vk:82,a:1082,b:1050,
c:0,d:0},KeyT:{vk:84,a:1077,b:1045,c:0,d:0},KeyY:{vk:89,a:1085,b:1053,c:0,d:0},KeyU:{vk:85,a:1075,b:1043,c:0,d:0},KeyI:{vk:73,a:1096,b:1064,c:0,d:0},KeyO:{vk:79,a:1097,b:1065,c:0,d:0},KeyP:{vk:80,
a:1079,b:1047,c:0,d:0},BracketLeft:{vk:219,a:1093,b:1061,c:0,d:0},BracketRight:{vk:221,a:1098,b:1066,c:0,d:0},Backslash:{vk:220,a:1105,b:1025,c:0,d:0},KeyA:{vk:65,a:1092,b:1060,c:0,d:0},KeyS:{vk:83,
a:1099,b:1067,c:0,d:0},KeyD:{vk:68,a:1074,b:1042,c:0,d:0},KeyF:{vk:70,a:1072,b:1040,c:0,d:0},KeyG:{vk:71,a:1087,b:1055,c:0,d:0},KeyH:{vk:72,a:1088,b:1056,c:0,d:0},KeyJ:{vk:74,a:1086,b:1054,c:0,d:0},
KeyK:{vk:75,a:1083,b:1051,c:0,d:0},KeyL:{vk:76,a:1076,b:1044,c:0,d:0},Semicolon:{vk:186,a:1078,b:1046,c:0,d:0},Quote:{vk:222,a:1101,b:1069,c:0,d:0},KeyZ:{vk:90,a:1103,b:1071,c:0,d:0},KeyX:{vk:88,
...
Comma:{vk:188,a:1073,b:1041,c:0,d:0},Period:{vk:190,a:1102,b:1070,c:0,d:0},Slash:{vk:191,a:47,b:63,c:0,d:0}}},{}],80:[function(e,t,n){t.exports={Backquote:{vk:192,a:39,b:34,c:0,d:0},Digit1:{vk:49,
a:49,b:33,c:185,d:0},Digit2:{vk:50,a:50,b:64,c:178,d:0},Digit3:{vk:51,a:51,b:35,c:179,d:0},Digit4:{vk:52,a:52,b:36,c:163,d:0},Digit5:{vk:53,a:53,b:37,c:162,d:0},Digit6:{vk:54,a:54,b:776,c:172,d:0},
Digit7:{vk:55,a:55,b:38,c:0,d:0},Digit8:{vk:56,a:56,b:42,c:0,d:0},Digit9:{vk:57,a:57,b:40,c:0,d:0},Digit0:{vk:48,a:48,b:41,c:0,d:0},Minus:{vk:189,a:45,b:95,c:0,d:0},Equal:{vk:187,a:61,b:43,c:167,d:0},
KeyQ:{vk:81,a:113,b:81,c:47,d:0},KeyW:{vk:87,a:119,b:87,c:63,d:0},KeyE:{vk:69,a:101,b:69,c:176,d:0},KeyR:{vk:82,a:114,b:82,c:0,d:0},KeyT:{vk:84,a:116,b:84,c:0,d:0},KeyY:{vk:89,a:121,b:89,c:0,d:0},
KeyU:{vk:85,a:117,b:85,c:0,d:0},KeyI:{vk:73,a:105,b:73,c:0,d:0},KeyO:{vk:79,a:111,b:79,c:0,d:0},KeyP:{vk:80,a:112,b:80,c:0,d:0},BracketLeft:{vk:219,a:769,b:768,c:0,d:0},BracketRight:{vk:221,a:91,
b:123,c:170,d:0},Backslash:{vk:220,a:93,b:125,c:186,d:0},KeyA:{vk:65,a:97,b:65,c:0,d:0},KeyS:{vk:83,a:115,b:83,c:0,d:0},KeyD:{vk:68,a:100,b:68,c:0,d:0},KeyF:{vk:70,a:102,b:70,c:0,d:0},KeyG:{vk:71,
a:103,b:71,c:0,d:0},KeyH:{vk:72,a:104,b:72,c:0,d:0},KeyJ:{vk:74,a:106,b:74,c:0,d:0},KeyK:{vk:75,a:107,b:75,c:0,d:0},KeyL:{vk:76,a:108,b:76,c:0,d:0},Semicolon:{vk:186,a:231,b:199,c:0,d:0},Quote:{
...
},{}],79:[function(e,t,n){t.exports={Backquote:{vk:220,a:92,b:124,c:0,d:0},Digit1:{vk:49,a:49,b:33,c:0,d:0},Digit2:{vk:50,a:50,b:34,c:64,d:0},Digit3:{vk:51,a:51,b:35,c:163,d:0},Digit4:{vk:52,a:52,
b:36,c:167,d:0},Digit5:{vk:53,a:53,b:37,c:8364,d:0},Digit6:{vk:54,a:54,b:38,c:0,d:0},Digit7:{vk:55,a:55,b:47,c:123,d:0},Digit8:{vk:56,a:56,b:40,c:91,d:0},Digit9:{vk:57,a:57,b:41,c:93,d:0},Digit0:{
vk:48,a:48,b:61,c:125,d:0},Minus:{vk:219,a:39,b:63,c:0,d:0},Equal:{vk:221,a:171,b:187,c:0,d:0},KeyQ:{vk:81,a:113,b:81,c:0,d:0},KeyW:{vk:87,a:119,b:87,c:0,d:0},KeyE:{vk:69,a:101,b:69,c:8364,d:0},KeyR:{
vk:82,a:114,b:82,c:0,d:0},KeyT:{vk:84,a:116,b:84,c:0,d:0},KeyY:{vk:89,a:121,b:89,c:0,d:0},KeyU:{vk:85,a:117,b:85,c:0,d:0},KeyI:{vk:73,a:105,b:73,c:0,d:0},KeyO:{vk:79,a:111,b:79,c:0,d:0},KeyP:{vk:80,
a:112,b:80,c:0,d:0},BracketLeft:{vk:187,a:43,b:42,c:776,d:0},BracketRight:{vk:186,a:769,b:768,c:93,d:0},Backslash:{vk:191,a:771,b:770,c:0,d:0},KeyA:{vk:65,a:97,b:65,c:0,d:0},KeyS:{vk:83,a:115,b:83,
c:0,d:0},KeyD:{vk:68,a:100,b:68,c:0,d:0},KeyF:{vk:70,a:102,b:70,c:0,d:0},KeyG:{vk:71,a:103,b:71,c:0,d:0},KeyH:{vk:72,a:104,b:72,c:0,d:0},KeyJ:{vk:74,a:106,b:74,c:0,d:0},KeyK:{vk:75,a:107,b:75,c:0,d:0
},KeyL:{vk:76,a:108,b:76,c:0,d:0},Semicolon:{vk:192,a:231,b:199,c:0,d:0},Quote:{vk:222,a:186,b:170,c:0,d:0},KeyZ:{vk:90,a:122,b:90,c:0,d:0},KeyX:{vk:88,a:120,b:88,c:0,d:0},KeyC:{vk:67,a:99,b:67,c:0,
d:0},KeyV:{vk:86,a:118,b:86,c:0,d:0},KeyB:{vk:66,a:98,b:66,c:0,d:0},KeyN:{vk:78,a:110,b:78,c:0,d:0},KeyM:{vk:77,a:109,b:77,c:0,d:0},Comma:{vk:188,a:44,b:59,c:0,d:0},Period:{vk:190,a:46,b:58,c:0,d:0},
Slash:{vk:189,a:45,b:95,c:0,d:0},IntlBackslash:{vk:226,a:60,b:62,c:0,d:0}}},{}],78:[function(e,t,n){t.exports={Backquote:{vk:220,a:92,b:124,c:0,d:0},Digit1:{vk:49,a:49,b:33,c:0,d:0},Digit2:{vk:50,
a:50,b:34,c:0,d:0},Digit3:{vk:51,a:51,b:163,c:0,d:0},Digit4:{vk:52,a:52,b:36,c:0,d:0},Digit5:{vk:53,a:53,b:37,c:8364,d:0},Digit6:{vk:54,a:54,b:38,c:0,d:0},Digit7:{vk:55,a:55,b:47,c:0,d:0},Digit8:{
vk:56,a:56,b:40,c:0,d:0},Digit9:{vk:57,a:57,b:41,c:0,d:0},Digit0:{vk:48,a:48,b:61,c:0,d:0},Minus:{vk:219,a:39,b:63,c:0,d:0},Equal:{vk:221,a:236,b:94,c:0,d:0},KeyQ:{vk:81,a:113,b:81,c:0,d:0},KeyW:{
vk:87,a:119,b:87,c:0,d:0},KeyE:{vk:69,a:101,b:69,c:8364,d:0},KeyR:{vk:82,a:114,b:82,c:0,d:0},KeyT:{vk:84,a:116,b:84,c:0,d:0},KeyY:{vk:89,a:121,b:89,c:0,d:0},KeyU:{vk:85,a:117,b:85,c:0,d:0},KeyI:{
vk:73,a:105,b:73,c:0,d:0},KeyO:{vk:79,a:111,b:79,c:0,d:0},KeyP:{vk:80,a:112,b:80,c:0,d:0},BracketLeft:{vk:186,a:232,b:233,c:91,d:123},BracketRight:{vk:187,a:43,b:42,c:93,d:125},Backslash:{vk:191,
a:249,b:167,c:0,d:0},KeyA:{vk:65,a:97,b:65,c:0,d:0},KeyS:{vk:83,a:115,b:83,c:0,d:0},KeyD:{vk:68,a:100,b:68,c:0,d:0},KeyF:{vk:70,a:102,b:70,c:0,d:0},KeyG:{vk:71,a:103,b:71,c:0,d:0},KeyH:{vk:72,a:104,
b:72,c:0,d:0},KeyJ:{vk:74,a:106,b:74,c:0,d:0},KeyK:{vk:75,a:107,b:75,c:0,d:0},KeyL:{vk:76,a:108,b:76,c:0,d:0},Semicolon:{vk:192,a:242,b:231,c:64,d:0},Quote:{vk:222,a:224,b:176,c:35,d:0},KeyZ:{vk:90,
...
b:77,c:0,d:0},Comma:{vk:188,a:44,b:59,c:0,d:0},Period:{vk:190,a:46,b:58,c:0,d:0},Slash:{vk:189,a:45,b:95,c:0,d:0},IntlBackslash:{vk:226,a:60,b:62,c:0,d:0}}},{}],77:[function(e,t,n){t.exports={
...
;n.LANGUAGE=r.map(Object.freeze({EN:i,DE:o,FR:s,IT:c,ES:l,PT:u,RU:d}))},{"../../lib/lang":139}],139:[function(e,t,n){"use strict";function a(e){return i.call(e).match(/^\[object (.+)\]$/)[1]}
