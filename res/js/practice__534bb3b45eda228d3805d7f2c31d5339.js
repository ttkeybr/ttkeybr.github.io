...
for(var i="function"==typeof require&&require,o=0;o<a.length;o++)r(a[o]);return r}({214:[function(e,t,n){"use strict";function a(e,t){
...
;m.mountApp(p.createElement(d.DatabaseLoader,{database:n,component:t},m.getMarkup(".Article"))),m.mountMenu(e)})}Object.defineProperty(n,"__esModule",{value:!0}),e("../lib/runtime/polyfill")
...
"../common/practice/ui/loader/database":28,"../common/practice/ui/root":41,"../common/util/storage/web":54,"../lib/http/url":136,"../lib/runtime/polyfill":147,"./init":210,"./mount":217,react:"react"
}],217:[function(e,t,n){"use strict";Object.defineProperty(n,"__esModule",{value:!0}),e("../lib/runtime/polyfill")
...
;o.initErrorPage(d),n.mountApp=function(e){u.render(e,d)},n.mountMenu=function(e){u.render(l.createElement(c.NavMenu,{avatar:s.userAvatar(e)}),f)},n.getMarkup=function(e){var t=r.one(d,e).outerHTML
...
"./ui/navmenu":230,react:"react","react-dom":"react-dom"}],230:[function(e,t,n){"use strict";Object.defineProperty(n,"__esModule",{value:!0})
...
"../../common/env":1,"../../lib/dom":130,"../../lib/lang":139,"../../lib/runtime/global":145}],219:[function(e,t,n){"use strict";function a(e){var t=e.reason;return i.createElement("article",{
...
react:"react","react-dom":"react-dom"}],210:[function(e,t,n){"use strict";Object.defineProperty(n,"__esModule",{value:!0})
...
t.then(function(){},function(){})}),o.meterTrackers(t)}},{"./error-log":209,"./thirdparty/google-ads":222,"./thirdparty/google-analytics":223,"./thirdparty/telemetry":227}],227:[function(e,t,n){
...
;var r=e("../../lib/dom"),i=e("../../lib/runtime/global"),o=e("../../lib/runtime/timer");n.load=function(){return new Promise(function(e,t){o.systemTimer.setTimeout(function(){
...
r.setHtml(o,a()),t(new Error("Ad blocker detected"))):e(!1)},1e3)})}},{"../../lib/dom":130,"../../lib/runtime/global":145,"../../lib/runtime/timer":156}],209:[function(e,t,n){"use strict"
...
;null!=d?s.push(i(u)+"="+i(String(d))):s.push(i(u))}return s.length&&(e=e+"?"+s.join("&")),e}},{"../lang":139}],228:[function(e,t,n){"use strict";function a(e){var t=e.className,n=e.avatar,a=o(t)
;return n.id&&n.imageUrl?s.createElement("img",{className:a,src:n.imageUrl}):n.id&&n.name?s.createElement(c.Identicon,{className:a,name:n.name}):s.createElement(l.default,{className:a})}
function r(e,t){for(var n=[],a=0,r=[e,t];a<r.length;a++)for(var i=0,o=r[a];i<o.length;i++){var s=o[i];-1==n.indexOf(s)&&n.push(s)}return n}Object.defineProperty(n,"__esModule",{value:!0})
;var i=e("tslib"),o=e("classnames"),s=e("react"),c=e("./identicon"),l=e("../../res/icon/custom/anonymous");n.userAvatar=function(e){null!=e&&null!=e.id||(e={id:null,email:null,userName:"anonymous",
fullName:"Anonymous",externalId:{}});for(var t=0,n=r(["google","facebook"],Object.keys(e.externalId));t<n.length;t++){var a=n[t],i=e.externalId[a];if(i)return{id:e.id,name:i.fullName,
imageUrl:i.imageUrl}}return{id:e.id,name:e.fullName||e.userName,imageUrl:null}},n.PublicAvatar=function(e){var t=e.className,n=e.avatar,r=o("PublicAvatar",t)
;return s.createElement("span",i.__assign({},{className:r,title:n.name}),s.createElement(a,{className:"PublicAvatar-image",avatar:n}),s.createElement("span",{className:"PublicAvatar-name"},n.name))},
n.Avatar=function(e){var t=e.className,n=e.avatar,r=o("Avatar",t);return s.createElement("div",i.__assign({},{className:r,title:n.name}),s.createElement("a",{href:"/account",className:"Avatar-link",
title:n.name},s.createElement(a,{className:"Avatar-image",avatar:n}),s.createElement("span",{className:"Avatar-name"},n.name)))},n.AvatarImage=a},{"../../res/icon/custom/anonymous":176,
"./identicon":229,classnames:"classnames",react:"react",tslib:"tslib"}],229:[function(e,t,n){"use strict";Object.defineProperty(n,"__esModule",{value:!0})
...
fontSize:"36"},l))}},{classnames:"classnames",react:"react"}],176:[function(e,t,n){"use strict";Object.defineProperty(n,"__esModule",{value:!0});var a=e("tslib"),r=e("../SvgIcon"),i=e("react")
;n.default=function(e){return i.createElement(r.SvgIcon,a.__assign({},e,{viewBox:"0 0 24 24"}),i.createElement("path",{
...
externalId:{}};n.currentEnv=a,n.currentUser=function(){var e=a();return null!=e.user?e.user:r}},{}]},{},[214]);
