...
Object.defineProperty(n,"__esModule",{value:!0})
;var c=e("tslib"),l=e("classnames"),u=e("react"),d=e("../../../lib/math/round"),f=e("../../../lib/runtime/global"),m=e("../../../lib/ui/button"),p=e("../../../lib/ui/iconbutton"),y=e("../../../lib/ui/label"),b=e("../../../lib/ui/lnf/fullscreen-button"),v=e("../../../lib/ui/lnf/text-size-button"),h=e("../../../lib/ui/lnf/theme-button"),g=e("../../../lib/ui/tour"),k=e("../../../res/icon/custom/help"),E=e("../../../res/icon/custom/settings"),_=e("../../../res/icon/material-design/av/web"),K=(e("../../../res/icon/material-design/content/redo"),
e("../../../res/icon/material-design/content/undo"),
e("../../keyboard/input")),S=e("../events"),N=e("../practice"),x=e("./keyboard"),w=e("./lesson/key"),O=e("./loader/lesson"),D=e("./sound"),C=e("./textinput");n.newPracticePage=function(e,t,n,a){
...
t.prototype.componentDidMount=function(){function e(e){s.reset()}function t(e){s.reset()}function n(e){s.reset()}K.translate(null);var a=this,r=a.props,i=r.settings,s=r.practice
;f.WINDOW.addEventListener("focus",e),f.WINDOW.addEventListener("blur",t),f.DOCUMENT.addEventListener("visibilitychange",n);var c=S.listenLessonStarted(function(e){
a.setState(Object.assign({},a.state,{fragment:e}),function(){a.textInput.focus()})}),l=S.listenLessonAdvanced(function(e,t){switch(a.textInput.update(e),t.hit){case!0:D.playSound(D.S_CLICK);break
;case!1:D.playSound(D.S_BLIP)}}),u=S.listenLessonCompleted(function(e,t){a.setState(Object.assign({},a.state,{result:e,achievements:t})),
...
t.prototype.componentWillUnmount=function(){K.translate(null),this.unlisten(),g.closeTour()},t.prototype.render=function(){function e(e){return u.createElement("div",{id:"Practice-controls",
...
K.translate(b()),E.reset()})}function y(){v.setState(Object.assign({},v.state,{focus:!1}),function(){v.keyboard&&v.keyboard.blur(),K.translate(null)})}function b(){var e=E.listen()
;return K.newTranslator(g.layout,g.emulateLayout,{onKeyDown:function(t){e.onKeyDown(t),v.keyboard&&v.keyboard.keyDown(t)},onKeyUp:function(t){e.onKeyUp(t),v.keyboard&&v.keyboard.keyUp(t)},
onInput:function(t){e.onInput(t)}})}var v=this,h=v.props,g=h.settings,k=h.lesson,E=h.practice,_=h.onConfigure,S=v.state,N=S.fragment,w=S.focus,O=S.layout;if(!N)return u.createElement("section",{
...
}(b.Component);n.Layer=_;var K=function(e){function t(){return null!==e&&e.apply(this,arguments)||this}return m.__extends(t,e),t.prototype.render=function(){
...
y:21},r.map(function(e){return u({layoutKey:e,elementMap:a})}))},t.contextTypes={layout:y.object.isRequired,full:y.bool.isRequired,elementMap:y.object.isRequired},t}(_);n.KeyLayer=K;var S=function(e){
...
className:"Keyboard-marker",x:21,y:21})},t.contextTypes={layout:y.object.isRequired,full:y.bool.isRequired,elementMap:y.object.isRequired},t}(_);n.MarkerLayer=S;var N=function(e){function t(){
...
for(var K=_[E],S=a(K),N=t.length,x=0;x<N;x++)S.add(t[x]);k[K.charCode]=S}for(var w=t.length,x=0;x<w;x++)n(t[x],x+1);return{get letters(){return e},get data(){return t},getKeyData:function(e){
...
return a(v.byId(b.getLayouts(),e),v.byId(n.MODE_TYPE,t))}function i(e,t){return e.load((n={},n[g]=null,n)).then(function(n){var a=n[g];return null!=a?(c(t,a),t.newSettings=!1,null):(c(t,{}),
